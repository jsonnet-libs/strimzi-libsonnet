    ...
    kafka: {
      ...
      listeners: {
        ...
        authentication: {
          ...
          '#withEnableECDSA':: d.fn(help='"Enable or disable ECDSA support by installing BouncyCastle crypto provider. Default value is `false`."', args=[d.arg(name='enableECDSA', type=d.T.boolean)]),
