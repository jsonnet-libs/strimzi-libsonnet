{
  ...
  spec: {
    ...
    jvmOptions: {
      ...
      '#withXX':: d.fn(help='"A map of -XX options to the JVM."', args=[d.arg(name='XX', type=d.T.object)]),
      withXX(XX): { spec+: { jvmOptions+: { '-XX': XX } } },
      '#withXXMixin':: d.fn(help='"A map of -XX options to the JVM."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='XX', type=d.T.object)]),
      withXXMixin(XX): { spec+: { jvmOptions+: { '-XX'+: XX } } },
