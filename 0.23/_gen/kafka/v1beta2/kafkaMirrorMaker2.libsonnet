{
  ...
  spec: {
    ...
    externalConfiguration: {
      '#env':: d.obj(help='"Allows to pass data from Secret or ConfigMap to the Kafka Connect pods as environment variables."'),
      env: {
      ...
      '#volumes':: d.obj(help='"Allows to pass data from Secret or ConfigMap to the Kafka Connect pods as volumes."'),
      volumes: {
