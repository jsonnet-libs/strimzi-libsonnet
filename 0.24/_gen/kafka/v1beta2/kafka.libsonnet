    ...
    kafka: {
      ...
      listeners: {
        ...
        authentication: {
          ...
          '#withTokenEndpointUri':: d.fn(help='"URI of the Token Endpoint to use with SASL_PLAIN mechanism when the client authenticates with clientId and a secret. "', args=[d.arg(name='tokenEndpointUri', type=d.T.string)]),
          withTokenEndpointUri(tokenEndpointUri): { authentication+: { tokenEndpointUri: tokenEndpointUri } },
          '#withType':: d.fn(help='"Authentication type. `oauth` type uses SASL OAUTHBEARER Authentication. `scram-sha-512` type uses SASL SCRAM-SHA-512 Authentication. `tls` type uses TLS Client Authentication. `tls` type is supported only on TLS listeners."', args=[d.arg(name='type', type=d.T.string)]),
        ...
        configuration: {
          ...
          '#withMaxConnectionCreationRate':: d.fn(help='"The maximum connection creation rate we allow in this listener at any time. New connections will be throttled if the limit is reached.Supported only on Kafka 2.7.0 and newer."', args=[d.arg(name='maxConnectionCreationRate', type=d.T.integer)]),
      ...
      '#withConfig':: d.fn(help='"Kafka broker config properties with the following prefixes cannot be set: listeners, advertised., broker., listener., host.name, port, inter.broker.listener.name, sasl., ssl., security., password., principal.builder.class, log.dir, zookeeper.connect, zookeeper.set.acl, zookeeper.ssl, zookeeper.clientCnxnSocket, authorizer., super.user, cruise.control.metrics.topic, cruise.control.metrics.reporter.bootstrap.servers (with the exception of: zookeeper.connection.timeout.ms, ssl.cipher.suites, ssl.protocol, ssl.enabled.protocols,cruise.control.metrics.topic.num.partitions, cruise.control.metrics.topic.replication.factor, cruise.control.metrics.topic.retention.ms,cruise.control.metrics.topic.auto.create.retries, cruise.control.metrics.topic.auto.create.timeout.ms,cruise.control.metrics.topic.min.insync.replicas)."', args=[d.arg(name='config', type=d.T.object)]),
