{
  ...
  '#':: d.pkg(name='kafkaConnectS2I', url='', help=''),
  ...
  '#new':: d.fn(help='new returns an instance of KafkaConnectS2I', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'kafka.strimzi.io/v1beta2',
    kind: 'KafkaConnectS2I',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"The specification of the Kafka Connect Source-to-Image (S2I) cluster."'),
  spec: {
    ...
    build: {
      ...
      plugins: {
        ...
        artifacts: {
          ...
          '#withSha512sum':: d.fn(help='"SHA512 checksum of the artifact. Optional. If specified, the checksum will be verified while building the new container. If not specified, the downloaded artifact will not be verified."', args=[d.arg(name='sha512sum', type=d.T.string)]),
          withSha512sum(sha512sum): { sha512sum: sha512sum },
          '#withType':: d.fn(help='"Artifact type. Currently, the supported artifact types are `tgz`, `jar`, and `zip`."', args=[d.arg(name='type', type=d.T.string)]),
          withType(type): { type: type },
          '#withUrl':: d.fn(help='"URL of the artifact which will be downloaded. Strimzi does not do any security scanning of the downloaded artifacts. For security reasons, you should first verify the artifacts manually and configure the checksum verification to make sure the same artifact is used in the automated build. Required."', args=[d.arg(name='url', type=d.T.string)]),
          withUrl(url): { url: url },
        },
    ...
    '#buildResources':: d.obj(help='"CPU and memory resources to reserve."'),
    buildResources: {
      '#withLimits':: d.fn(help='', args=[d.arg(name='limits', type=d.T.object)]),
      withLimits(limits): { spec+: { buildResources+: { limits: limits } } },
      '#withLimitsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='limits', type=d.T.object)]),
      withLimitsMixin(limits): { spec+: { buildResources+: { limits+: limits } } },
      '#withRequests':: d.fn(help='', args=[d.arg(name='requests', type=d.T.object)]),
      withRequests(requests): { spec+: { buildResources+: { requests: requests } } },
      '#withRequestsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='requests', type=d.T.object)]),
      withRequestsMixin(requests): { spec+: { buildResources+: { requests+: requests } } },
    },
    ...
    '#withInsecureSourceRepository':: d.fn(help="\"When true this configures the source repository with the 'Local' reference policy and an import policy that accepts insecure source tags.\"", args=[d.arg(name='insecureSourceRepository', type=d.T.boolean)]),
    withInsecureSourceRepository(insecureSourceRepository): { spec+: { insecureSourceRepository: insecureSourceRepository } },
