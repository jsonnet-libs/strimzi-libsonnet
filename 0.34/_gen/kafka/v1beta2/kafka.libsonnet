{
  ...
  spec: {
    ...
    kafka: {
      ...
      rack: {
        '#withTopologyKey':: d.fn(help="\"A key that matches labels assigned to the Kubernetes cluster nodes. The value of the label is used to set a broker's `broker.rack` config, and the `client.rack` config for Kafka Connect or MirrorMaker 2.0.\"", args=[d.arg(name='topologyKey', type=d.T.string)]),
      ...
      '#template':: d.obj(help='"Template for Kafka cluster resources. The template allows users to specify how the `StatefulSet`, `Pods`, and `Services` are generated."'),
      template: {
    ...
    zookeeper: {
      ...
      '#template':: d.obj(help='"Template for ZooKeeper cluster resources. The template allows users to specify how the `StatefulSet`, `Pods`, and `Services` are generated."'),
      template: {
