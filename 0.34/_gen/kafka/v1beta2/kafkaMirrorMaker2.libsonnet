{
  ...
  '#spec':: d.obj(help='"The specification of the Kafka MirrorMaker 2.0 cluster."'),
  spec: {
    ...
    clusters: {
      ...
      '#tls':: d.obj(help='"TLS configuration for connecting MirrorMaker 2.0 connectors to a cluster."'),
      tls: {
    ...
    '#mirrors':: d.obj(help='"Configuration of the MirrorMaker 2.0 connectors."'),
    mirrors: {
      '#checkpointConnector':: d.obj(help='"The specification of the Kafka MirrorMaker 2.0 checkpoint connector."'),
      checkpointConnector: {
      ...
      '#heartbeatConnector':: d.obj(help='"The specification of the Kafka MirrorMaker 2.0 heartbeat connector."'),
      heartbeatConnector: {
        '#autoRestart':: d.obj(help='"Automatic restart of connector and tasks configuration."'),
        autoRestart: {
          '#withEnabled':: d.fn(help='"Whether automatic restart for failed connectors and tasks should be enabled or disabled."', args=[d.arg(name='enabled', type=d.T.boolean)]),
      ...
      '#sourceConnector':: d.obj(help='"The specification of the Kafka MirrorMaker 2.0 source connector."'),
      sourceConnector: {
        '#autoRestart':: d.obj(help='"Automatic restart of connector and tasks configuration."'),
        autoRestart: {
          '#withEnabled':: d.fn(help='"Whether automatic restart for failed connectors and tasks should be enabled or disabled."', args=[d.arg(name='enabled', type=d.T.boolean)]),
      ...
      '#withSourceCluster':: d.fn(help='"The alias of the source cluster used by the Kafka MirrorMaker 2.0 connectors. The alias must match a cluster in the list at `spec.clusters`."', args=[d.arg(name='sourceCluster', type=d.T.string)]),
      withSourceCluster(sourceCluster): { sourceCluster: sourceCluster },
      '#withTargetCluster':: d.fn(help='"The alias of the target cluster used by the Kafka MirrorMaker 2.0 connectors. The alias must match a cluster in the list at `spec.clusters`."', args=[d.arg(name='targetCluster', type=d.T.string)]),
    ...
    '#withMirrors':: d.fn(help='"Configuration of the MirrorMaker 2.0 connectors."', args=[d.arg(name='mirrors', type=d.T.array)]),
    withMirrors(mirrors): { spec+: { mirrors: if std.isArray(v=mirrors) then mirrors else [mirrors] } },
    '#withMirrorsMixin':: d.fn(help='"Configuration of the MirrorMaker 2.0 connectors."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='mirrors', type=d.T.array)]),
