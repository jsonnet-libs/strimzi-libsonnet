    ...
    kafka: {
      ...
      listeners: {
        ...
        configuration: {
          ...
          brokers: {
            '#withAdvertisedHost':: d.fn(help="\"The host name which will be used in the brokers' `advertised.brokers`.\"", args=[d.arg(name='advertisedHost', type=d.T.string)]),
            withAdvertisedHost(advertisedHost): { advertisedHost: advertisedHost },
            '#withAdvertisedPort':: d.fn(help="\"The port number which will be used in the brokers' `advertised.brokers`.\"", args=[d.arg(name='advertisedPort', type=d.T.integer)]),
