{
  ...
  spec: {
    ...
    tracing: {
      '#withType':: d.fn(help='"Type of the tracing used. Currently the only supported types are `jaeger` for OpenTracing (Jaeger) tracing and `opentelemetry` for OpenTelemetry tracing. The OpenTracing (Jaeger) tracing is deprecated."', args=[d.arg(name='type', type=d.T.string)]),
