{
  ...
  spec: {
    ...
    '#withConnectCluster':: d.fn(help='"The cluster alias used for Kafka Connect. The alias must match a cluster in the list at `spec.clusters`."', args=[d.arg(name='connectCluster', type=d.T.string)]),
