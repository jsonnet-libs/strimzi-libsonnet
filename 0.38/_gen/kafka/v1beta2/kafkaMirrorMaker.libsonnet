{
  ...
  spec: {
    ...
    '#withVersion':: d.fn(help='"The Kafka MirrorMaker version. Defaults to {DefaultKafkaVersion}. Consult the documentation to understand the process required to upgrade or downgrade the version."', args=[d.arg(name='version', type=d.T.string)]),
