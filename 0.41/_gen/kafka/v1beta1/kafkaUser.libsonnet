  ...
  spec: {
    ...
    authorization: {
      ...
      acls: {
        ...
        '#withOperations':: d.fn(help='"List of operations which will be allowed or denied. Supported operations are: Read, Write, Create, Delete, Alter, Describe, ClusterAction, AlterConfigs, DescribeConfigs, IdempotentWrite and All."', args=[d.arg(name='operations', type=d.T.array)]),
        withOperations(operations): { operations: if std.isArray(v=operations) then operations else [operations] },
        '#withOperationsMixin':: d.fn(help='"List of operations which will be allowed or denied. Supported operations are: Read, Write, Create, Delete, Alter, Describe, ClusterAction, AlterConfigs, DescribeConfigs, IdempotentWrite and All."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='operations', type=d.T.array)]),
