{
  ...
  spec: {
    ...
    kafka: {
      ...
      '#listeners':: d.obj(help='"Configures listeners of Kafka brokers."'),
      listeners: {
        ...
        authentication: {
          ...
          '#secrets':: d.obj(help='"Secrets to be mounted to /opt/kafka/custom-authn-secrets/custom-listener-_<listener_name>-<port>_/_<secret_name>_."'),
          secrets: {
            '#withKey':: d.fn(help='"The key under which the secret value is stored in the Kubernetes Secret."', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { key: key },
            '#withSecretName':: d.fn(help='"The name of the Kubernetes Secret containing the secret value."', args=[d.arg(name='secretName', type=d.T.string)]),
          ...
          '#withListenerConfig':: d.fn(help='"Configuration to be used for a specific listener. All values are prefixed with listener.name._<listener_name>_."', args=[d.arg(name='listenerConfig', type=d.T.object)]),
          withListenerConfig(listenerConfig): { authentication+: { listenerConfig: listenerConfig } },
          '#withListenerConfigMixin':: d.fn(help='"Configuration to be used for a specific listener. All values are prefixed with listener.name._<listener_name>_."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='listenerConfig', type=d.T.object)]),
          ...
          '#withSecrets':: d.fn(help='"Secrets to be mounted to /opt/kafka/custom-authn-secrets/custom-listener-_<listener_name>-<port>_/_<secret_name>_."', args=[d.arg(name='secrets', type=d.T.array)]),
          withSecrets(secrets): { authentication+: { secrets: if std.isArray(v=secrets) then secrets else [secrets] } },
          '#withSecretsMixin':: d.fn(help='"Secrets to be mounted to /opt/kafka/custom-authn-secrets/custom-listener-_<listener_name>-<port>_/_<secret_name>_."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='secrets', type=d.T.array)]),
        ...
        configuration: {
          ...
          bootstrap: {
            ...
            '#withAnnotations':: d.fn(help='"Annotations that will be added to the `Ingress`, `Route`, or `Service` resource. You can use this field to configure DNS providers such as External DNS. This field can be used only with `loadbalancer`, `nodeport`, `route`, or `ingress` type listeners."', args=[d.arg(name='annotations', type=d.T.object)]),
            withAnnotations(annotations): { configuration+: { bootstrap+: { annotations: annotations } } },
            '#withAnnotationsMixin':: d.fn(help='"Annotations that will be added to the `Ingress`, `Route`, or `Service` resource. You can use this field to configure DNS providers such as External DNS. This field can be used only with `loadbalancer`, `nodeport`, `route`, or `ingress` type listeners."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='annotations', type=d.T.object)]),
            ...
            '#withHost':: d.fn(help='"The bootstrap host. This field will be used in the Ingress resource or in the Route resource to specify the desired hostname. This field can be used only with `route` (optional) or `ingress` (required) type listeners."', args=[d.arg(name='host', type=d.T.string)]),
            ...
            '#withNodePort':: d.fn(help='"Node port for the bootstrap service. This field can be used only with `nodeport` type listener."', args=[d.arg(name='nodePort', type=d.T.integer)]),
          ...
          '#withClass':: d.fn(help='"Configures a specific class for `Ingress` and `LoadBalancer` that defines which controller will be used. This field can only be used with `ingress` and `loadbalancer` type listeners. If not specified, the default controller is used. For an `ingress` listener, set the `ingressClassName` property in the `Ingress` resources. For a `loadbalancer` listener, set the `loadBalancerClass` property  in the `Service` resources."', args=[d.arg(name='class', type=d.T.string)]),
          withClass(class): { configuration+: { class: class } },
          '#withCreateBootstrapService':: d.fn(help='"Whether to create the bootstrap service or not. The bootstrap service is created by default (if not specified differently). This field can be used with the `loadBalancer` type listener."', args=[d.arg(name='createBootstrapService', type=d.T.boolean)]),
          withCreateBootstrapService(createBootstrapService): { configuration+: { createBootstrapService: createBootstrapService } },
          '#withExternalTrafficPolicy':: d.fn(help='"Specifies whether the service routes external traffic to node-local or cluster-wide endpoints. `Cluster` may cause a second hop to another node and obscures the client source IP. `Local` avoids a second hop for LoadBalancer and Nodeport type services and preserves the client source IP (when supported by the infrastructure). If unspecified, Kubernetes will use `Cluster` as the default.This field can be used only with `loadbalancer` or `nodeport` type listener."', args=[d.arg(name='externalTrafficPolicy', type=d.T.string)]),
          withExternalTrafficPolicy(externalTrafficPolicy): { configuration+: { externalTrafficPolicy: externalTrafficPolicy } },
          '#withFinalizers':: d.fn(help='"A list of finalizers which will be configured for the `LoadBalancer` type Services created for this listener. If supported by the platform, the finalizer `service.kubernetes.io/load-balancer-cleanup` to make sure that the external load balancer is deleted together with the service.For more information, see https://kubernetes.io/docs/tasks/access-application-cluster/create-external-load-balancer/#garbage-collecting-load-balancers. This field can be used only with `loadbalancer` type listeners."', args=[d.arg(name='finalizers', type=d.T.array)]),
          withFinalizers(finalizers): { configuration+: { finalizers: if std.isArray(v=finalizers) then finalizers else [finalizers] } },
          '#withFinalizersMixin':: d.fn(help='"A list of finalizers which will be configured for the `LoadBalancer` type Services created for this listener. If supported by the platform, the finalizer `service.kubernetes.io/load-balancer-cleanup` to make sure that the external load balancer is deleted together with the service.For more information, see https://kubernetes.io/docs/tasks/access-application-cluster/create-external-load-balancer/#garbage-collecting-load-balancers. This field can be used only with `loadbalancer` type listeners."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='finalizers', type=d.T.array)]),
          ...
          '#withLoadBalancerSourceRanges':: d.fn(help='"A list of CIDR ranges (for example `10.0.0.0/8` or `130.211.204.1/32`) from which clients can connect to load balancer type listeners. If supported by the platform, traffic through the loadbalancer is restricted to the specified CIDR ranges. This field is applicable only for loadbalancer type services and is ignored if the cloud provider does not support the feature. This field can be used only with `loadbalancer` type listener."', args=[d.arg(name='loadBalancerSourceRanges', type=d.T.array)]),
          ...
          '#withPreferredNodePortAddressType':: d.fn(help='"Defines which address type should be used as the node address. Available types are: `ExternalDNS`, `ExternalIP`, `InternalDNS`, `InternalIP` and `Hostname`. By default, the addresses will be used in the following order (the first one found will be used):\\n\\n* `ExternalDNS`\\n* `ExternalIP`\\n* `InternalDNS`\\n* `InternalIP`\\n* `Hostname`\\n\\nThis field is used to select the preferred address type, which is checked first. If no address is found for this address type, the other types are checked in the default order. This field can only be used with `nodeport` type listener."', args=[d.arg(name='preferredNodePortAddressType', type=d.T.string)]),
          ...
          '#withPublishNotReadyAddresses':: d.fn(help='"Configures whether the service endpoints are considered \\"ready\\" even if the Pods themselves are not. Defaults to `false`. This field can not be used with `internal` type listeners."', args=[d.arg(name='publishNotReadyAddresses', type=d.T.boolean)]),
          withPublishNotReadyAddresses(publishNotReadyAddresses): { configuration+: { publishNotReadyAddresses: publishNotReadyAddresses } },
          '#withUseServiceDnsDomain':: d.fn(help='"Configures whether the Kubernetes service DNS domain should be used or not. If set to `true`, the generated addresses will contain the service DNS domain suffix (by default `.cluster.local`, can be configured using environment variable `KUBERNETES_SERVICE_DNS_DOMAIN`). Defaults to `false`.This field can be used only with `internal` and `cluster-ip` type listeners."', args=[d.arg(name='useServiceDnsDomain', type=d.T.boolean)]),
        ...
        withPort(port): { port: port },
        '#withTls':: d.fn(help='"Enables TLS encryption on the listener. This is a required property."', args=[d.arg(name='tls', type=d.T.boolean)]),
        withTls(tls): { tls: tls },
