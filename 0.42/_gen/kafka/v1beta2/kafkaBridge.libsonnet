{
  ...
  spec: {
    ...
    consumer: {
      ...
      '#withEnabled':: d.fn(help='"Whether the HTTP consumer should be enabled or disabled, default is enabled."', args=[d.arg(name='enabled', type=d.T.boolean)]),
    ...
    producer: {
      ...
      '#withEnabled':: d.fn(help='"Whether the HTTP producer should be enabled or disabled, default is enabled."', args=[d.arg(name='enabled', type=d.T.boolean)]),
