{
  ...
  spec: {
      ...
      template: {
        ...
        pod: {
          ...
          volumes: {
            ...
            '#secret':: d.obj(help='"Secret to use populate the volume."'),
            secret: {
              '#items':: d.obj(help=''),
              items: {
                '#withKey':: d.fn(help='', args=[d.arg(name='key', type=d.T.string)]),
    ...
    kafka: {
      ...
      '#storage':: d.obj(help='"Storage configuration (disk). Cannot be updated. This property is required when node pools are not used."'),
      storage: {
        '#overrides':: d.obj(help='"Overrides for individual brokers. The `overrides` field allows you to specify a different configuration for different brokers."'),
        overrides: {
        ...
        volumes: {
          ...
          '#withOverrides':: d.fn(help='"Overrides for individual brokers. The `overrides` field allows you to specify a different configuration for different brokers."', args=[d.arg(name='overrides', type=d.T.array)]),
          withOverrides(overrides): { overrides: if std.isArray(v=overrides) then overrides else [overrides] },
          '#withOverridesMixin':: d.fn(help='"Overrides for individual brokers. The `overrides` field allows you to specify a different configuration for different brokers."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='overrides', type=d.T.array)]),
      ...
      '#withConfig':: d.fn(help='"Kafka broker config properties with the following prefixes cannot be set: listeners, advertised., broker., listener., host.name, port, inter.broker.listener.name, sasl., ssl., security., password., log.dir, zookeeper.connect, zookeeper.set.acl, zookeeper.ssl, zookeeper.clientCnxnSocket, authorizer., super.user, cruise.control.metrics.topic, cruise.control.metrics.reporter.bootstrap.servers, node.id, process.roles, controller., metadata.log.dir, zookeeper.metadata.migration.enable, client.quota.callback.static.kafka.admin., client.quota.callback.static.produce, client.quota.callback.static.fetch, client.quota.callback.static.storage.per.volume.limit.min.available., client.quota.callback.static.excluded.principal.name.list (with the exception of: zookeeper.connection.timeout.ms, sasl.server.max.receive.size, ssl.cipher.suites, ssl.protocol, ssl.enabled.protocols, ssl.secure.random.implementation, cruise.control.metrics.topic.num.partitions, cruise.control.metrics.topic.replication.factor, cruise.control.metrics.topic.retention.ms, cruise.control.metrics.topic.auto.create.retries, cruise.control.metrics.topic.auto.create.timeout.ms, cruise.control.metrics.topic.min.insync.replicas, controller.quorum.election.backoff.max.ms, controller.quorum.election.timeout.ms, controller.quorum.fetch.timeout.ms)."', args=[d.arg(name='config', type=d.T.object)]),
      ...
      '#withReplicas':: d.fn(help='"The number of pods in the cluster. This property is required when node pools are not used."', args=[d.arg(name='replicas', type=d.T.integer)]),
    ...
    '#zookeeper':: d.obj(help='"Configuration of the ZooKeeper cluster. This section is required when running a ZooKeeper-based Apache Kafka cluster."'),
    zookeeper: {
