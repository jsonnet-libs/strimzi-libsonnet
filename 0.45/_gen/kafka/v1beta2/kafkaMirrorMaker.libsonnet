{
  ...
  '#':: d.pkg(name='kafkaMirrorMaker', url='', help=''),
  ...
  '#new':: d.fn(help='new returns an instance of KafkaMirrorMaker', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'kafka.strimzi.io/v1beta2',
    kind: 'KafkaMirrorMaker',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"The specification of Kafka MirrorMaker."'),
  spec: {
    '#consumer':: d.obj(help='"Configuration of source cluster."'),
    consumer: {
      ...
      authentication: {
        ...
        accessToken: {
          ...
          withKey(key): { spec+: { consumer+: { authentication+: { accessToken+: { key: key } } } } },
          ...
          withSecretName(secretName): { spec+: { consumer+: { authentication+: { accessToken+: { secretName: secretName } } } } },
        },
        ...
        certificateAndKey: {
          ...
          withCertificate(certificate): { spec+: { consumer+: { authentication+: { certificateAndKey+: { certificate: certificate } } } } },
          '#withKey':: d.fn(help='"The name of the private key in the Secret."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { spec+: { consumer+: { authentication+: { certificateAndKey+: { key: key } } } } },
          '#withSecretName':: d.fn(help='"The name of the Secret containing the certificate."', args=[d.arg(name='secretName', type=d.T.string)]),
          withSecretName(secretName): { spec+: { consumer+: { authentication+: { certificateAndKey+: { secretName: secretName } } } } },
        },
        ...
        clientAssertion: {
          '#withKey':: d.fn(help='"The key under which the secret value is stored in the Kubernetes Secret."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { spec+: { consumer+: { authentication+: { clientAssertion+: { key: key } } } } },
          '#withSecretName':: d.fn(help='"The name of the Kubernetes Secret containing the secret value."', args=[d.arg(name='secretName', type=d.T.string)]),
          withSecretName(secretName): { spec+: { consumer+: { authentication+: { clientAssertion+: { secretName: secretName } } } } },
        },
        ...
        clientSecret: {
          '#withKey':: d.fn(help='"The key under which the secret value is stored in the Kubernetes Secret."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { spec+: { consumer+: { authentication+: { clientSecret+: { key: key } } } } },
          '#withSecretName':: d.fn(help='"The name of the Kubernetes Secret containing the secret value."', args=[d.arg(name='secretName', type=d.T.string)]),
          withSecretName(secretName): { spec+: { consumer+: { authentication+: { clientSecret+: { secretName: secretName } } } } },
        },
        ...
        passwordSecret: {
          ...
          withPassword(password): { spec+: { consumer+: { authentication+: { passwordSecret+: { password: password } } } } },
          '#withSecretName':: d.fn(help='"The name of the Secret containing the password."', args=[d.arg(name='secretName', type=d.T.string)]),
          withSecretName(secretName): { spec+: { consumer+: { authentication+: { passwordSecret+: { secretName: secretName } } } } },
        },
        ...
        refreshToken: {
          '#withKey':: d.fn(help='"The key under which the secret value is stored in the Kubernetes Secret."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { spec+: { consumer+: { authentication+: { refreshToken+: { key: key } } } } },
          '#withSecretName':: d.fn(help='"The name of the Kubernetes Secret containing the secret value."', args=[d.arg(name='secretName', type=d.T.string)]),
          withSecretName(secretName): { spec+: { consumer+: { authentication+: { refreshToken+: { secretName: secretName } } } } },
        },
        ...
        withAccessTokenIsJwt(accessTokenIsJwt): { spec+: { consumer+: { authentication+: { accessTokenIsJwt: accessTokenIsJwt } } } },
        ...
        withAccessTokenLocation(accessTokenLocation): { spec+: { consumer+: { authentication+: { accessTokenLocation: accessTokenLocation } } } },
        ...
        withAudience(audience): { spec+: { consumer+: { authentication+: { audience: audience } } } },
        ...
        withClientAssertionLocation(clientAssertionLocation): { spec+: { consumer+: { authentication+: { clientAssertionLocation: clientAssertionLocation } } } },
        ...
        withClientAssertionType(clientAssertionType): { spec+: { consumer+: { authentication+: { clientAssertionType: clientAssertionType } } } },
        ...
        withClientId(clientId): { spec+: { consumer+: { authentication+: { clientId: clientId } } } },
        ...
        withConnectTimeoutSeconds(connectTimeoutSeconds): { spec+: { consumer+: { authentication+: { connectTimeoutSeconds: connectTimeoutSeconds } } } },
        ...
        withDisableTlsHostnameVerification(disableTlsHostnameVerification): { spec+: { consumer+: { authentication+: { disableTlsHostnameVerification: disableTlsHostnameVerification } } } },
        ...
        withEnableMetrics(enableMetrics): { spec+: { consumer+: { authentication+: { enableMetrics: enableMetrics } } } },
        ...
        withHttpRetries(httpRetries): { spec+: { consumer+: { authentication+: { httpRetries: httpRetries } } } },
        ...
        withHttpRetryPauseMs(httpRetryPauseMs): { spec+: { consumer+: { authentication+: { httpRetryPauseMs: httpRetryPauseMs } } } },
        ...
        withIncludeAcceptHeader(includeAcceptHeader): { spec+: { consumer+: { authentication+: { includeAcceptHeader: includeAcceptHeader } } } },
        ...
        withMaxTokenExpirySeconds(maxTokenExpirySeconds): { spec+: { consumer+: { authentication+: { maxTokenExpirySeconds: maxTokenExpirySeconds } } } },
        ...
        withReadTimeoutSeconds(readTimeoutSeconds): { spec+: { consumer+: { authentication+: { readTimeoutSeconds: readTimeoutSeconds } } } },
        '#withSaslExtensions':: d.fn(help='"SASL extensions parameters."', args=[d.arg(name='saslExtensions', type=d.T.object)]),
        withSaslExtensions(saslExtensions): { spec+: { consumer+: { authentication+: { saslExtensions: saslExtensions } } } },
        ...
        withSaslExtensionsMixin(saslExtensions): { spec+: { consumer+: { authentication+: { saslExtensions+: saslExtensions } } } },
        ...
        withScope(scope): { spec+: { consumer+: { authentication+: { scope: scope } } } },
        ...
        withTlsTrustedCertificates(tlsTrustedCertificates): { spec+: { consumer+: { authentication+: { tlsTrustedCertificates: if std.isArray(v=tlsTrustedCertificates) then tlsTrustedCertificates else [tlsTrustedCertificates] } } } },
        ...
        withTlsTrustedCertificatesMixin(tlsTrustedCertificates): { spec+: { consumer+: { authentication+: { tlsTrustedCertificates+: if std.isArray(v=tlsTrustedCertificates) then tlsTrustedCertificates else [tlsTrustedCertificates] } } } },
        '#withTokenEndpointUri':: d.fn(help='"Authorization server token endpoint URI."', args=[d.arg(name='tokenEndpointUri', type=d.T.string)]),
        withTokenEndpointUri(tokenEndpointUri): { spec+: { consumer+: { authentication+: { tokenEndpointUri: tokenEndpointUri } } } },
        ...
        withType(type): { spec+: { consumer+: { authentication+: { type: type } } } },
        '#withUsername':: d.fn(help='"Username used for the authentication."', args=[d.arg(name='username', type=d.T.string)]),
        withUsername(username): { spec+: { consumer+: { authentication+: { username: username } } } },
      },
      '#tls':: d.obj(help='"TLS configuration for connecting MirrorMaker to the cluster."'),
      tls: {
        ...
        withTrustedCertificates(trustedCertificates): { spec+: { consumer+: { tls+: { trustedCertificates: if std.isArray(v=trustedCertificates) then trustedCertificates else [trustedCertificates] } } } },
        ...
        withTrustedCertificatesMixin(trustedCertificates): { spec+: { consumer+: { tls+: { trustedCertificates+: if std.isArray(v=trustedCertificates) then trustedCertificates else [trustedCertificates] } } } },
      },
      ...
      withBootstrapServers(bootstrapServers): { spec+: { consumer+: { bootstrapServers: bootstrapServers } } },
      '#withConfig':: d.fn(help='"The MirrorMaker consumer config. Properties with the following prefixes cannot be set: ssl., bootstrap.servers, group.id, sasl., security., interceptor.classes (with the exception of: ssl.endpoint.identification.algorithm, ssl.cipher.suites, ssl.protocol, ssl.enabled.protocols)."', args=[d.arg(name='config', type=d.T.object)]),
      withConfig(config): { spec+: { consumer+: { config: config } } },
      '#withConfigMixin':: d.fn(help='"The MirrorMaker consumer config. Properties with the following prefixes cannot be set: ssl., bootstrap.servers, group.id, sasl., security., interceptor.classes (with the exception of: ssl.endpoint.identification.algorithm, ssl.cipher.suites, ssl.protocol, ssl.enabled.protocols)."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='config', type=d.T.object)]),
      withConfigMixin(config): { spec+: { consumer+: { config+: config } } },
      '#withGroupId':: d.fn(help='"A unique string that identifies the consumer group this consumer belongs to."', args=[d.arg(name='groupId', type=d.T.string)]),
      withGroupId(groupId): { spec+: { consumer+: { groupId: groupId } } },
      '#withNumStreams':: d.fn(help='"Specifies the number of consumer stream threads to create."', args=[d.arg(name='numStreams', type=d.T.integer)]),
      withNumStreams(numStreams): { spec+: { consumer+: { numStreams: numStreams } } },
      '#withOffsetCommitInterval':: d.fn(help='"Specifies the offset auto-commit interval in ms. Default value is 60000."', args=[d.arg(name='offsetCommitInterval', type=d.T.integer)]),
      withOffsetCommitInterval(offsetCommitInterval): { spec+: { consumer+: { offsetCommitInterval: offsetCommitInterval } } },
    },
    ...
    '#logging':: d.obj(help='"Logging configuration for MirrorMaker."'),
    logging: {
    ...
    '#producer':: d.obj(help='"Configuration of target cluster."'),
    producer: {
      '#authentication':: d.obj(help='"Authentication configuration for connecting to the cluster."'),
      authentication: {
        '#accessToken':: d.obj(help='"Link to Kubernetes Secret containing the access token which was obtained from the authorization server."'),
        accessToken: {
          '#withKey':: d.fn(help='"The key under which the secret value is stored in the Kubernetes Secret."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { spec+: { producer+: { authentication+: { accessToken+: { key: key } } } } },
          '#withSecretName':: d.fn(help='"The name of the Kubernetes Secret containing the secret value."', args=[d.arg(name='secretName', type=d.T.string)]),
          withSecretName(secretName): { spec+: { producer+: { authentication+: { accessToken+: { secretName: secretName } } } } },
        },
        '#certificateAndKey':: d.obj(help='"Reference to the `Secret` which holds the certificate and private key pair."'),
        certificateAndKey: {
          '#withCertificate':: d.fn(help='"The name of the file certificate in the Secret."', args=[d.arg(name='certificate', type=d.T.string)]),
          withCertificate(certificate): { spec+: { producer+: { authentication+: { certificateAndKey+: { certificate: certificate } } } } },
          '#withKey':: d.fn(help='"The name of the private key in the Secret."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { spec+: { producer+: { authentication+: { certificateAndKey+: { key: key } } } } },
          '#withSecretName':: d.fn(help='"The name of the Secret containing the certificate."', args=[d.arg(name='secretName', type=d.T.string)]),
          withSecretName(secretName): { spec+: { producer+: { authentication+: { certificateAndKey+: { secretName: secretName } } } } },
        },
        '#clientAssertion':: d.obj(help='"Link to Kubernetes secret containing the client assertion which was manually configured for the client."'),
        clientAssertion: {
          '#withKey':: d.fn(help='"The key under which the secret value is stored in the Kubernetes Secret."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { spec+: { producer+: { authentication+: { clientAssertion+: { key: key } } } } },
          '#withSecretName':: d.fn(help='"The name of the Kubernetes Secret containing the secret value."', args=[d.arg(name='secretName', type=d.T.string)]),
          withSecretName(secretName): { spec+: { producer+: { authentication+: { clientAssertion+: { secretName: secretName } } } } },
        },
        '#clientSecret':: d.obj(help='"Link to Kubernetes Secret containing the OAuth client secret which the Kafka client can use to authenticate against the OAuth server and use the token endpoint URI."'),
        clientSecret: {
          '#withKey':: d.fn(help='"The key under which the secret value is stored in the Kubernetes Secret."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { spec+: { producer+: { authentication+: { clientSecret+: { key: key } } } } },
          '#withSecretName':: d.fn(help='"The name of the Kubernetes Secret containing the secret value."', args=[d.arg(name='secretName', type=d.T.string)]),
          withSecretName(secretName): { spec+: { producer+: { authentication+: { clientSecret+: { secretName: secretName } } } } },
        },
        '#passwordSecret':: d.obj(help='"Reference to the `Secret` which holds the password."'),
        passwordSecret: {
          '#withPassword':: d.fn(help='"The name of the key in the Secret under which the password is stored."', args=[d.arg(name='password', type=d.T.string)]),
          withPassword(password): { spec+: { producer+: { authentication+: { passwordSecret+: { password: password } } } } },
          '#withSecretName':: d.fn(help='"The name of the Secret containing the password."', args=[d.arg(name='secretName', type=d.T.string)]),
          withSecretName(secretName): { spec+: { producer+: { authentication+: { passwordSecret+: { secretName: secretName } } } } },
        },
        '#refreshToken':: d.obj(help='"Link to Kubernetes Secret containing the refresh token which can be used to obtain access token from the authorization server."'),
        refreshToken: {
          '#withKey':: d.fn(help='"The key under which the secret value is stored in the Kubernetes Secret."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { spec+: { producer+: { authentication+: { refreshToken+: { key: key } } } } },
          '#withSecretName':: d.fn(help='"The name of the Kubernetes Secret containing the secret value."', args=[d.arg(name='secretName', type=d.T.string)]),
          withSecretName(secretName): { spec+: { producer+: { authentication+: { refreshToken+: { secretName: secretName } } } } },
        },
        '#tlsTrustedCertificates':: d.obj(help='"Trusted certificates for TLS connection to the OAuth server."'),
        tlsTrustedCertificates: {
          '#withCertificate':: d.fn(help='"The name of the file certificate in the secret."', args=[d.arg(name='certificate', type=d.T.string)]),
        ...
        '#withAccessTokenIsJwt':: d.fn(help='"Configure whether access token should be treated as JWT. This should be set to `false` if the authorization server returns opaque tokens. Defaults to `true`."', args=[d.arg(name='accessTokenIsJwt', type=d.T.boolean)]),
        withAccessTokenIsJwt(accessTokenIsJwt): { spec+: { producer+: { authentication+: { accessTokenIsJwt: accessTokenIsJwt } } } },
        '#withAccessTokenLocation':: d.fn(help='"Path to the token file containing an access token to be used for authentication."', args=[d.arg(name='accessTokenLocation', type=d.T.string)]),
        withAccessTokenLocation(accessTokenLocation): { spec+: { producer+: { authentication+: { accessTokenLocation: accessTokenLocation } } } },
        '#withAudience':: d.fn(help='"OAuth audience to use when authenticating against the authorization server. Some authorization servers require the audience to be explicitly set. The possible values depend on how the authorization server is configured. By default, `audience` is not specified when performing the token endpoint request."', args=[d.arg(name='audience', type=d.T.string)]),
        withAudience(audience): { spec+: { producer+: { authentication+: { audience: audience } } } },
        '#withClientAssertionLocation':: d.fn(help='"Path to the file containing the client assertion to be used for authentication."', args=[d.arg(name='clientAssertionLocation', type=d.T.string)]),
        withClientAssertionLocation(clientAssertionLocation): { spec+: { producer+: { authentication+: { clientAssertionLocation: clientAssertionLocation } } } },
        '#withClientAssertionType':: d.fn(help='"The client assertion type. If not set, and either `clientAssertion` or `clientAssertionLocation` is configured, this value defaults to `urn:ietf:params:oauth:client-assertion-type:jwt-bearer`."', args=[d.arg(name='clientAssertionType', type=d.T.string)]),
        withClientAssertionType(clientAssertionType): { spec+: { producer+: { authentication+: { clientAssertionType: clientAssertionType } } } },
        '#withClientId':: d.fn(help='"OAuth Client ID which the Kafka client can use to authenticate against the OAuth server and use the token endpoint URI."', args=[d.arg(name='clientId', type=d.T.string)]),
        withClientId(clientId): { spec+: { producer+: { authentication+: { clientId: clientId } } } },
        '#withConnectTimeoutSeconds':: d.fn(help='"The connect timeout in seconds when connecting to authorization server. If not set, the effective connect timeout is 60 seconds."', args=[d.arg(name='connectTimeoutSeconds', type=d.T.integer)]),
        withConnectTimeoutSeconds(connectTimeoutSeconds): { spec+: { producer+: { authentication+: { connectTimeoutSeconds: connectTimeoutSeconds } } } },
        '#withDisableTlsHostnameVerification':: d.fn(help='"Enable or disable TLS hostname verification. Default value is `false`."', args=[d.arg(name='disableTlsHostnameVerification', type=d.T.boolean)]),
        withDisableTlsHostnameVerification(disableTlsHostnameVerification): { spec+: { producer+: { authentication+: { disableTlsHostnameVerification: disableTlsHostnameVerification } } } },
        '#withEnableMetrics':: d.fn(help='"Enable or disable OAuth metrics. Default value is `false`."', args=[d.arg(name='enableMetrics', type=d.T.boolean)]),
        withEnableMetrics(enableMetrics): { spec+: { producer+: { authentication+: { enableMetrics: enableMetrics } } } },
        '#withHttpRetries':: d.fn(help='"The maximum number of retries to attempt if an initial HTTP request fails. If not set, the default is to not attempt any retries."', args=[d.arg(name='httpRetries', type=d.T.integer)]),
        withHttpRetries(httpRetries): { spec+: { producer+: { authentication+: { httpRetries: httpRetries } } } },
        '#withHttpRetryPauseMs':: d.fn(help='"The pause to take before retrying a failed HTTP request. If not set, the default is to not pause at all but to immediately repeat a request."', args=[d.arg(name='httpRetryPauseMs', type=d.T.integer)]),
        withHttpRetryPauseMs(httpRetryPauseMs): { spec+: { producer+: { authentication+: { httpRetryPauseMs: httpRetryPauseMs } } } },
        '#withIncludeAcceptHeader':: d.fn(help='"Whether the Accept header should be set in requests to the authorization servers. The default value is `true`."', args=[d.arg(name='includeAcceptHeader', type=d.T.boolean)]),
        withIncludeAcceptHeader(includeAcceptHeader): { spec+: { producer+: { authentication+: { includeAcceptHeader: includeAcceptHeader } } } },
        '#withMaxTokenExpirySeconds':: d.fn(help='"Set or limit time-to-live of the access tokens to the specified number of seconds. This should be set if the authorization server returns opaque tokens."', args=[d.arg(name='maxTokenExpirySeconds', type=d.T.integer)]),
        withMaxTokenExpirySeconds(maxTokenExpirySeconds): { spec+: { producer+: { authentication+: { maxTokenExpirySeconds: maxTokenExpirySeconds } } } },
        '#withReadTimeoutSeconds':: d.fn(help='"The read timeout in seconds when connecting to authorization server. If not set, the effective read timeout is 60 seconds."', args=[d.arg(name='readTimeoutSeconds', type=d.T.integer)]),
        withReadTimeoutSeconds(readTimeoutSeconds): { spec+: { producer+: { authentication+: { readTimeoutSeconds: readTimeoutSeconds } } } },
        '#withSaslExtensions':: d.fn(help='"SASL extensions parameters."', args=[d.arg(name='saslExtensions', type=d.T.object)]),
        withSaslExtensions(saslExtensions): { spec+: { producer+: { authentication+: { saslExtensions: saslExtensions } } } },
        '#withSaslExtensionsMixin':: d.fn(help='"SASL extensions parameters."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='saslExtensions', type=d.T.object)]),
        withSaslExtensionsMixin(saslExtensions): { spec+: { producer+: { authentication+: { saslExtensions+: saslExtensions } } } },
        '#withScope':: d.fn(help='"OAuth scope to use when authenticating against the authorization server. Some authorization servers require this to be set. The possible values depend on how authorization server is configured. By default `scope` is not specified when doing the token endpoint request."', args=[d.arg(name='scope', type=d.T.string)]),
        withScope(scope): { spec+: { producer+: { authentication+: { scope: scope } } } },
        '#withTlsTrustedCertificates':: d.fn(help='"Trusted certificates for TLS connection to the OAuth server."', args=[d.arg(name='tlsTrustedCertificates', type=d.T.array)]),
        withTlsTrustedCertificates(tlsTrustedCertificates): { spec+: { producer+: { authentication+: { tlsTrustedCertificates: if std.isArray(v=tlsTrustedCertificates) then tlsTrustedCertificates else [tlsTrustedCertificates] } } } },
        '#withTlsTrustedCertificatesMixin':: d.fn(help='"Trusted certificates for TLS connection to the OAuth server."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tlsTrustedCertificates', type=d.T.array)]),
        withTlsTrustedCertificatesMixin(tlsTrustedCertificates): { spec+: { producer+: { authentication+: { tlsTrustedCertificates+: if std.isArray(v=tlsTrustedCertificates) then tlsTrustedCertificates else [tlsTrustedCertificates] } } } },
        '#withTokenEndpointUri':: d.fn(help='"Authorization server token endpoint URI."', args=[d.arg(name='tokenEndpointUri', type=d.T.string)]),
        withTokenEndpointUri(tokenEndpointUri): { spec+: { producer+: { authentication+: { tokenEndpointUri: tokenEndpointUri } } } },
        '#withType':: d.fn(help="\"Authentication type. Currently the supported types are `tls`, `scram-sha-256`, `scram-sha-512`, `plain`, and 'oauth'. `scram-sha-256` and `scram-sha-512` types use SASL SCRAM-SHA-256 and SASL SCRAM-SHA-512 Authentication, respectively. `plain` type uses SASL PLAIN Authentication. `oauth` type uses SASL OAUTHBEARER Authentication. The `tls` type uses TLS Client Authentication. The `tls` type is supported only over TLS connections.\"", args=[d.arg(name='type', type=d.T.string)]),
        withType(type): { spec+: { producer+: { authentication+: { type: type } } } },
        '#withUsername':: d.fn(help='"Username used for the authentication."', args=[d.arg(name='username', type=d.T.string)]),
        withUsername(username): { spec+: { producer+: { authentication+: { username: username } } } },
      },
      '#tls':: d.obj(help='"TLS configuration for connecting MirrorMaker to the cluster."'),
      tls: {
        '#trustedCertificates':: d.obj(help='"Trusted certificates for TLS connection."'),
        ...
        '#withTrustedCertificates':: d.fn(help='"Trusted certificates for TLS connection."', args=[d.arg(name='trustedCertificates', type=d.T.array)]),
        withTrustedCertificates(trustedCertificates): { spec+: { producer+: { tls+: { trustedCertificates: if std.isArray(v=trustedCertificates) then trustedCertificates else [trustedCertificates] } } } },
        '#withTrustedCertificatesMixin':: d.fn(help='"Trusted certificates for TLS connection."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='trustedCertificates', type=d.T.array)]),
        withTrustedCertificatesMixin(trustedCertificates): { spec+: { producer+: { tls+: { trustedCertificates+: if std.isArray(v=trustedCertificates) then trustedCertificates else [trustedCertificates] } } } },
      },
      '#withAbortOnSendFailure':: d.fn(help='"Flag to set the MirrorMaker to exit on a failed send. Default value is `true`."', args=[d.arg(name='abortOnSendFailure', type=d.T.boolean)]),
      withAbortOnSendFailure(abortOnSendFailure): { spec+: { producer+: { abortOnSendFailure: abortOnSendFailure } } },
      '#withBootstrapServers':: d.fn(help='"A list of host:port pairs for establishing the initial connection to the Kafka cluster."', args=[d.arg(name='bootstrapServers', type=d.T.string)]),
      withBootstrapServers(bootstrapServers): { spec+: { producer+: { bootstrapServers: bootstrapServers } } },
      '#withConfig':: d.fn(help='"The MirrorMaker producer config. Properties with the following prefixes cannot be set: ssl., bootstrap.servers, sasl., security., interceptor.classes (with the exception of: ssl.endpoint.identification.algorithm, ssl.cipher.suites, ssl.protocol, ssl.enabled.protocols)."', args=[d.arg(name='config', type=d.T.object)]),
      withConfig(config): { spec+: { producer+: { config: config } } },
      '#withConfigMixin':: d.fn(help='"The MirrorMaker producer config. Properties with the following prefixes cannot be set: ssl., bootstrap.servers, sasl., security., interceptor.classes (with the exception of: ssl.endpoint.identification.algorithm, ssl.cipher.suites, ssl.protocol, ssl.enabled.protocols)."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='config', type=d.T.object)]),
    ...
    '#template':: d.obj(help='"Template to specify how Kafka MirrorMaker resources, `Deployments` and `Pods`, are generated."'),
    template: {
      '#deployment':: d.obj(help='"Template for Kafka MirrorMaker `Deployment`."'),
      deployment: {
      ...
      '#mirrorMakerContainer':: d.obj(help='"Template for Kafka MirrorMaker container."'),
      mirrorMakerContainer: {
        ...
        securityContext: {
          ...
          appArmorProfile: {
            ...
            withLocalhostProfile(localhostProfile): { spec+: { template+: { mirrorMakerContainer+: { securityContext+: { appArmorProfile+: { localhostProfile: localhostProfile } } } } } },
            '#withType':: d.fn(help='', args=[d.arg(name='type', type=d.T.string)]),
            withType(type): { spec+: { template+: { mirrorMakerContainer+: { securityContext+: { appArmorProfile+: { type: type } } } } } },
          },
          '#capabilities':: d.obj(help=''),
          capabilities: {
            '#withAdd':: d.fn(help='', args=[d.arg(name='add', type=d.T.array)]),
            withAdd(add): { spec+: { template+: { mirrorMakerContainer+: { securityContext+: { capabilities+: { add: if std.isArray(v=add) then add else [add] } } } } } },
            '#withAddMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='add', type=d.T.array)]),
            withAddMixin(add): { spec+: { template+: { mirrorMakerContainer+: { securityContext+: { capabilities+: { add+: if std.isArray(v=add) then add else [add] } } } } } },
            '#withDrop':: d.fn(help='', args=[d.arg(name='drop', type=d.T.array)]),
            withDrop(drop): { spec+: { template+: { mirrorMakerContainer+: { securityContext+: { capabilities+: { drop: if std.isArray(v=drop) then drop else [drop] } } } } } },
            '#withDropMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='drop', type=d.T.array)]),
            withDropMixin(drop): { spec+: { template+: { mirrorMakerContainer+: { securityContext+: { capabilities+: { drop+: if std.isArray(v=drop) then drop else [drop] } } } } } },
          },
          '#seLinuxOptions':: d.obj(help=''),
          seLinuxOptions: {
            '#withLevel':: d.fn(help='', args=[d.arg(name='level', type=d.T.string)]),
            withLevel(level): { spec+: { template+: { mirrorMakerContainer+: { securityContext+: { seLinuxOptions+: { level: level } } } } } },
            '#withRole':: d.fn(help='', args=[d.arg(name='role', type=d.T.string)]),
            withRole(role): { spec+: { template+: { mirrorMakerContainer+: { securityContext+: { seLinuxOptions+: { role: role } } } } } },
            '#withType':: d.fn(help='', args=[d.arg(name='type', type=d.T.string)]),
            withType(type): { spec+: { template+: { mirrorMakerContainer+: { securityContext+: { seLinuxOptions+: { type: type } } } } } },
            '#withUser':: d.fn(help='', args=[d.arg(name='user', type=d.T.string)]),
            withUser(user): { spec+: { template+: { mirrorMakerContainer+: { securityContext+: { seLinuxOptions+: { user: user } } } } } },
          },
          '#seccompProfile':: d.obj(help=''),
          seccompProfile: {
            '#withLocalhostProfile':: d.fn(help='', args=[d.arg(name='localhostProfile', type=d.T.string)]),
            withLocalhostProfile(localhostProfile): { spec+: { template+: { mirrorMakerContainer+: { securityContext+: { seccompProfile+: { localhostProfile: localhostProfile } } } } } },
            '#withType':: d.fn(help='', args=[d.arg(name='type', type=d.T.string)]),
            withType(type): { spec+: { template+: { mirrorMakerContainer+: { securityContext+: { seccompProfile+: { type: type } } } } } },
          },
          '#windowsOptions':: d.obj(help=''),
          windowsOptions: {
            '#withGmsaCredentialSpec':: d.fn(help='', args=[d.arg(name='gmsaCredentialSpec', type=d.T.string)]),
            withGmsaCredentialSpec(gmsaCredentialSpec): { spec+: { template+: { mirrorMakerContainer+: { securityContext+: { windowsOptions+: { gmsaCredentialSpec: gmsaCredentialSpec } } } } } },
            '#withGmsaCredentialSpecName':: d.fn(help='', args=[d.arg(name='gmsaCredentialSpecName', type=d.T.string)]),
            withGmsaCredentialSpecName(gmsaCredentialSpecName): { spec+: { template+: { mirrorMakerContainer+: { securityContext+: { windowsOptions+: { gmsaCredentialSpecName: gmsaCredentialSpecName } } } } } },
            '#withHostProcess':: d.fn(help='', args=[d.arg(name='hostProcess', type=d.T.boolean)]),
            withHostProcess(hostProcess): { spec+: { template+: { mirrorMakerContainer+: { securityContext+: { windowsOptions+: { hostProcess: hostProcess } } } } } },
            '#withRunAsUserName':: d.fn(help='', args=[d.arg(name='runAsUserName', type=d.T.string)]),
            withRunAsUserName(runAsUserName): { spec+: { template+: { mirrorMakerContainer+: { securityContext+: { windowsOptions+: { runAsUserName: runAsUserName } } } } } },
          },
          '#withAllowPrivilegeEscalation':: d.fn(help='', args=[d.arg(name='allowPrivilegeEscalation', type=d.T.boolean)]),
          withAllowPrivilegeEscalation(allowPrivilegeEscalation): { spec+: { template+: { mirrorMakerContainer+: { securityContext+: { allowPrivilegeEscalation: allowPrivilegeEscalation } } } } },
          '#withPrivileged':: d.fn(help='', args=[d.arg(name='privileged', type=d.T.boolean)]),
          withPrivileged(privileged): { spec+: { template+: { mirrorMakerContainer+: { securityContext+: { privileged: privileged } } } } },
          '#withProcMount':: d.fn(help='', args=[d.arg(name='procMount', type=d.T.string)]),
          withProcMount(procMount): { spec+: { template+: { mirrorMakerContainer+: { securityContext+: { procMount: procMount } } } } },
          '#withReadOnlyRootFilesystem':: d.fn(help='', args=[d.arg(name='readOnlyRootFilesystem', type=d.T.boolean)]),
          withReadOnlyRootFilesystem(readOnlyRootFilesystem): { spec+: { template+: { mirrorMakerContainer+: { securityContext+: { readOnlyRootFilesystem: readOnlyRootFilesystem } } } } },
          '#withRunAsGroup':: d.fn(help='', args=[d.arg(name='runAsGroup', type=d.T.integer)]),
          withRunAsGroup(runAsGroup): { spec+: { template+: { mirrorMakerContainer+: { securityContext+: { runAsGroup: runAsGroup } } } } },
          '#withRunAsNonRoot':: d.fn(help='', args=[d.arg(name='runAsNonRoot', type=d.T.boolean)]),
          withRunAsNonRoot(runAsNonRoot): { spec+: { template+: { mirrorMakerContainer+: { securityContext+: { runAsNonRoot: runAsNonRoot } } } } },
          '#withRunAsUser':: d.fn(help='', args=[d.arg(name='runAsUser', type=d.T.integer)]),
          withRunAsUser(runAsUser): { spec+: { template+: { mirrorMakerContainer+: { securityContext+: { runAsUser: runAsUser } } } } },
        },
        ...
        withEnv(env): { spec+: { template+: { mirrorMakerContainer+: { env: if std.isArray(v=env) then env else [env] } } } },
        ...
        withEnvMixin(env): { spec+: { template+: { mirrorMakerContainer+: { env+: if std.isArray(v=env) then env else [env] } } } },
        ...
        withVolumeMounts(volumeMounts): { spec+: { template+: { mirrorMakerContainer+: { volumeMounts: if std.isArray(v=volumeMounts) then volumeMounts else [volumeMounts] } } } },
        ...
        withVolumeMountsMixin(volumeMounts): { spec+: { template+: { mirrorMakerContainer+: { volumeMounts+: if std.isArray(v=volumeMounts) then volumeMounts else [volumeMounts] } } } },
      },
      '#pod':: d.obj(help='"Template for Kafka MirrorMaker `Pods`."'),
      pod: {
      ...
      '#podDisruptionBudget':: d.obj(help='"Template for Kafka MirrorMaker `PodDisruptionBudget`."'),
      podDisruptionBudget: {
      ...
      '#serviceAccount':: d.obj(help='"Template for the Kafka MirrorMaker service account."'),
      serviceAccount: {
        '#metadata':: d.obj(help='"Metadata applied to the resource."'),
        metadata: {
          '#withAnnotations':: d.fn(help='"Annotations added to the Kubernetes resource."', args=[d.arg(name='annotations', type=d.T.object)]),
    ...
    '#tracing':: d.obj(help='"The configuration of tracing in Kafka MirrorMaker."'),
    tracing: {
    ...
    '#withImage':: d.fn(help='"The container image used for Kafka MirrorMaker pods. If no image name is explicitly specified, it is determined based on the `spec.version` configuration. The image names are specifically mapped to corresponding versions in the Cluster Operator configuration."', args=[d.arg(name='image', type=d.T.string)]),
    withImage(image): { spec+: { image: image } },
    '#withInclude':: d.fn(help='"List of topics which are included for mirroring. This option allows any regular expression using Java-style regular expressions. Mirroring two topics named A and B is achieved by using the expression `A\\\\|B`. Or, as a special case, you can mirror all topics using the regular expression `*`. You can also specify multiple regular expressions separated by commas."', args=[d.arg(name='include', type=d.T.string)]),
    withInclude(include): { spec+: { include: include } },
    ...
    '#withVersion':: d.fn(help='"The Kafka MirrorMaker version. Defaults to the latest version. Consult the documentation to understand the process required to upgrade or downgrade the version."', args=[d.arg(name='version', type=d.T.string)]),
    withVersion(version): { spec+: { version: version } },
    '#withWhitelist':: d.fn(help='"List of topics which are included for mirroring. This option allows any regular expression using Java-style regular expressions. Mirroring two topics named A and B is achieved by using the expression `A\\\\|B`. Or, as a special case, you can mirror all topics using the regular expression `*`. You can also specify multiple regular expressions separated by commas."', args=[d.arg(name='whitelist', type=d.T.string)]),
    withWhitelist(whitelist): { spec+: { whitelist: whitelist } },
  },
  '#mixin': 'ignore',
  mixin: self,
}
