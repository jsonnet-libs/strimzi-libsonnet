  ...
  spec: {
    ...
    cruiseControl: {
      ...
      brokerCapacity: {
        ...
        '#withDisk':: d.fn(help='"Broker capacity for disk in bytes. Use a number value with either standard Kubernetes byte units (K, M, G, or T), their bibyte (power of two) equivalents (Ki, Mi, Gi, or Ti), or a byte value with or without E notation. For example, 100000M, 100000Mi, 104857600000, or 1e+11."', args=[d.arg(name='disk', type=d.T.string)]),
      ...
      template: {
        ...
        pod: {
          ...
          volumes: {
            ...
            emptyDir: {
              '#sizeLimit':: d.obj(help=''),
              sizeLimit: {
                '#withAmount':: d.fn(help='', args=[d.arg(name='amount', type=d.T.string)]),
                withAmount(amount): { emptyDir+: { sizeLimit+: { amount: amount } } },
                '#withFormat':: d.fn(help='', args=[d.arg(name='format', type=d.T.string)]),
                withFormat(format): { emptyDir+: { sizeLimit+: { format: format } } },
              },
    ...
    entityOperator: {
      ...
      topicOperator: {
        ...
        '#withReconciliationIntervalSeconds':: d.fn(help='"Interval between periodic reconciliations in seconds. Ignored if reconciliationIntervalMs is set."', args=[d.arg(name='reconciliationIntervalSeconds', type=d.T.integer)]),
    ...
    '#jmxTrans':: d.obj(help='"As of Strimzi 0.35.0, JMXTrans is not supported anymore and this option is ignored."'),
    jmxTrans: {
      '#kafkaQueries':: d.obj(help='"Queries to send to the Kafka brokers to define what data should be read from each broker. For more information on these properties see, xref:type-JmxTransQueryTemplate-reference[`JmxTransQueryTemplate` schema reference]."'),
      kafkaQueries: {
        '#withAttributes':: d.fn(help='"Determine which attributes of the targeted MBean should be included."', args=[d.arg(name='attributes', type=d.T.array)]),
        withAttributes(attributes): { attributes: if std.isArray(v=attributes) then attributes else [attributes] },
        '#withAttributesMixin':: d.fn(help='"Determine which attributes of the targeted MBean should be included."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='attributes', type=d.T.array)]),
        withAttributesMixin(attributes): { attributes+: if std.isArray(v=attributes) then attributes else [attributes] },
        '#withOutputs':: d.fn(help='"List of the names of output definitions specified in the spec.kafka.jmxTrans.outputDefinitions that have defined where JMX metrics are pushed to, and in which data format."', args=[d.arg(name='outputs', type=d.T.array)]),
        withOutputs(outputs): { outputs: if std.isArray(v=outputs) then outputs else [outputs] },
        '#withOutputsMixin':: d.fn(help='"List of the names of output definitions specified in the spec.kafka.jmxTrans.outputDefinitions that have defined where JMX metrics are pushed to, and in which data format."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='outputs', type=d.T.array)]),
        withOutputsMixin(outputs): { outputs+: if std.isArray(v=outputs) then outputs else [outputs] },
        '#withTargetMBean':: d.fn(help='"If using wildcards instead of a specific MBean then the data is gathered from multiple MBeans. Otherwise if specifying an MBean then data is gathered from that specified MBean."', args=[d.arg(name='targetMBean', type=d.T.string)]),
        withTargetMBean(targetMBean): { targetMBean: targetMBean },
      },
      '#outputDefinitions':: d.obj(help='"Defines the output hosts that will be referenced later on. For more information on these properties see, xref:type-JmxTransOutputDefinitionTemplate-reference[`JmxTransOutputDefinitionTemplate` schema reference]."'),
      outputDefinitions: {
        '#withFlushDelayInSeconds':: d.fn(help='"How many seconds the JmxTrans waits before pushing a new set of data out."', args=[d.arg(name='flushDelayInSeconds', type=d.T.integer)]),
        withFlushDelayInSeconds(flushDelayInSeconds): { flushDelayInSeconds: flushDelayInSeconds },
        '#withHost':: d.fn(help='"The DNS/hostname of the remote host that the data is pushed to."', args=[d.arg(name='host', type=d.T.string)]),
        withHost(host): { host: host },
        '#withName':: d.fn(help='"Template for setting the name of the output definition. This is used to identify where to send the results of queries should be sent."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { name: name },
        '#withOutputType':: d.fn(help='"Template for setting the format of the data that will be pushed.For more information see https://github.com/jmxtrans/jmxtrans/wiki/OutputWriters[JmxTrans OutputWriters]."', args=[d.arg(name='outputType', type=d.T.string)]),
        withOutputType(outputType): { outputType: outputType },
        '#withPort':: d.fn(help='"The port of the remote host that the data is pushed to."', args=[d.arg(name='port', type=d.T.integer)]),
        withPort(port): { port: port },
        '#withTypeNames':: d.fn(help='"Template for filtering data to be included in response to a wildcard query. For more information see https://github.com/jmxtrans/jmxtrans/wiki/Queries[JmxTrans queries]."', args=[d.arg(name='typeNames', type=d.T.array)]),
        withTypeNames(typeNames): { typeNames: if std.isArray(v=typeNames) then typeNames else [typeNames] },
        '#withTypeNamesMixin':: d.fn(help='"Template for filtering data to be included in response to a wildcard query. For more information see https://github.com/jmxtrans/jmxtrans/wiki/Queries[JmxTrans queries]."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='typeNames', type=d.T.array)]),
      ...
      template: {
        ...
        '#serviceAccount':: d.obj(help='"Template for the JmxTrans service account."'),
        serviceAccount: {
          '#metadata':: d.obj(help='"Metadata applied to the resource."'),
          metadata: {
            '#withAnnotations':: d.fn(help='"Annotations added to the Kubernetes resource."', args=[d.arg(name='annotations', type=d.T.object)]),
    ...
    kafka: {
      ...
      authorization: {
        ...
        tlsTrustedCertificates: {
          ...
          '#withPattern':: d.fn(help='"Pattern for the certificate files in the secret. Use the link:https://en.wikipedia.org/wiki/Glob_(programming)[_glob syntax_] for the pattern. All files in the secret that match the pattern are used."', args=[d.arg(name='pattern', type=d.T.string)]),
        ...
        '#withConnectTimeoutSeconds':: d.fn(help='"The connect timeout in seconds when connecting to authorization server. If not set, the effective connect timeout is 60 seconds."', args=[d.arg(name='connectTimeoutSeconds', type=d.T.integer)]),
        ...
        '#withEnableMetrics':: d.fn(help='"Enable or disable OAuth metrics. The default value is `false`."', args=[d.arg(name='enableMetrics', type=d.T.boolean)]),
        ...
        '#withGrantsAlwaysLatest':: d.fn(help='"Controls whether the latest grants are fetched for a new session. When enabled, grants are retrieved from Keycloak and cached for the user. The default value is `false`."', args=[d.arg(name='grantsAlwaysLatest', type=d.T.boolean)]),
        withGrantsAlwaysLatest(grantsAlwaysLatest): { spec+: { kafka+: { authorization+: { grantsAlwaysLatest: grantsAlwaysLatest } } } },
        '#withGrantsGcPeriodSeconds':: d.fn(help='"The time, in seconds, between consecutive runs of a job that cleans stale grants from the cache. The default value is 300."', args=[d.arg(name='grantsGcPeriodSeconds', type=d.T.integer)]),
        withGrantsGcPeriodSeconds(grantsGcPeriodSeconds): { spec+: { kafka+: { authorization+: { grantsGcPeriodSeconds: grantsGcPeriodSeconds } } } },
        '#withGrantsMaxIdleTimeSeconds':: d.fn(help='"The time, in seconds, after which an idle grant can be evicted from the cache. The default value is 300."', args=[d.arg(name='grantsMaxIdleTimeSeconds', type=d.T.integer)]),
        ...
        '#withHttpRetries':: d.fn(help='"The maximum number of retries to attempt if an initial HTTP request fails. If not set, the default is to not attempt any retries."', args=[d.arg(name='httpRetries', type=d.T.integer)]),
        withHttpRetries(httpRetries): { spec+: { kafka+: { authorization+: { httpRetries: httpRetries } } } },
        '#withIncludeAcceptHeader':: d.fn(help='"Whether the Accept header should be set in requests to the authorization servers. The default value is `true`."', args=[d.arg(name='includeAcceptHeader', type=d.T.boolean)]),
        ...
        '#withReadTimeoutSeconds':: d.fn(help='"The read timeout in seconds when connecting to authorization server. If not set, the effective read timeout is 60 seconds."', args=[d.arg(name='readTimeoutSeconds', type=d.T.integer)]),
      ...
      listeners: {
        ...
        authentication: {
          '#clientSecret':: d.obj(help='"Link to Kubernetes Secret containing the OAuth client secret which the Kafka broker can use to authenticate against the authorization server and use the introspect endpoint URI."'),
          clientSecret: {
          ...
          '#secrets':: d.obj(help='"Secrets to be mounted to `/opt/kafka/custom-authn-secrets/custom-listener-<listener_name>-<port>/<secret_name>`."'),
          secrets: {
            '#withKey':: d.fn(help='"The key under which the secret value is stored in the Kubernetes Secret."', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { key: key },
            '#withSecretName':: d.fn(help='"The name of the Kubernetes Secret containing the secret value."', args=[d.arg(name='secretName', type=d.T.string)]),
          ...
          '#withAccessTokenIsJwt':: d.fn(help='"Configure whether the access token is treated as JWT. This must be set to `false` if the authorization server returns opaque tokens. Defaults to `true`."', args=[d.arg(name='accessTokenIsJwt', type=d.T.boolean)]),
          withAccessTokenIsJwt(accessTokenIsJwt): { authentication+: { accessTokenIsJwt: accessTokenIsJwt } },
          '#withCheckAccessTokenType':: d.fn(help="\"Configure whether the access token type check is performed or not. This should be set to `false` if the authorization server does not include 'typ' claim in JWT token. Defaults to `true`.\"", args=[d.arg(name='checkAccessTokenType', type=d.T.boolean)]),
          withCheckAccessTokenType(checkAccessTokenType): { authentication+: { checkAccessTokenType: checkAccessTokenType } },
          '#withCheckAudience':: d.fn(help='"Enable or disable audience checking. Audience checks identify the recipients of tokens. If audience checking is enabled, the OAuth Client ID also has to be configured using the `clientId` property. The Kafka broker will reject tokens that do not have its `clientId` in their `aud` (audience) claim.Default value is `false`."', args=[d.arg(name='checkAudience', type=d.T.boolean)]),
          withCheckAudience(checkAudience): { authentication+: { checkAudience: checkAudience } },
          '#withCheckIssuer':: d.fn(help='"Enable or disable issuer checking. By default issuer is checked using the value configured by `validIssuerUri`. Default value is `true`."', args=[d.arg(name='checkIssuer', type=d.T.boolean)]),
          withCheckIssuer(checkIssuer): { authentication+: { checkIssuer: checkIssuer } },
          '#withClientAudience':: d.fn(help="\"The audience to use when making requests to the authorization server's token endpoint. Used for inter-broker authentication and for configuring OAuth 2.0 over PLAIN using the `clientId` and `secret` method.\"", args=[d.arg(name='clientAudience', type=d.T.string)]),
          withClientAudience(clientAudience): { authentication+: { clientAudience: clientAudience } },
          '#withClientGrantType':: d.fn(help="\"The grant type to use when making requests to the authorization server's token endpoint. Used for `OAuth over PLAIN` when `username` and `password` passed via SASL_PLAIN client authentication are passed on to the authorization server as `clientId` and `secret`.\"", args=[d.arg(name='clientGrantType', type=d.T.string)]),
          withClientGrantType(clientGrantType): { authentication+: { clientGrantType: clientGrantType } },
          '#withClientId':: d.fn(help='"OAuth Client ID which the Kafka broker can use to authenticate against the authorization server and use the introspect endpoint URI."', args=[d.arg(name='clientId', type=d.T.string)]),
          withClientId(clientId): { authentication+: { clientId: clientId } },
          '#withClientScope':: d.fn(help="\"The scope to use when making requests to the authorization server's token endpoint. Used for inter-broker authentication and for configuring OAuth 2.0 over PLAIN using the `clientId` and `secret` method.\"", args=[d.arg(name='clientScope', type=d.T.string)]),
          ...
          '#withCustomClaimCheck':: d.fn(help='"JsonPath filter query to be applied to the JWT token or to the response of the introspection endpoint for additional token validation. Not set by default."', args=[d.arg(name='customClaimCheck', type=d.T.string)]),
          ...
          '#withEnableECDSA':: d.fn(help='"Enable or disable ECDSA support by installing BouncyCastle crypto provider. ECDSA support is always enabled. The BouncyCastle libraries are no longer packaged with Strimzi. Value is ignored."', args=[d.arg(name='enableECDSA', type=d.T.boolean)]),
          withEnableECDSA(enableECDSA): { authentication+: { enableECDSA: enableECDSA } },
          '#withEnableMetrics':: d.fn(help='"Enable or disable OAuth metrics. Default value is `false`."', args=[d.arg(name='enableMetrics', type=d.T.boolean)]),
          withEnableMetrics(enableMetrics): { authentication+: { enableMetrics: enableMetrics } },
          '#withEnableOauthBearer':: d.fn(help='"Enable or disable OAuth authentication over SASL_OAUTHBEARER. Default value is `true`."', args=[d.arg(name='enableOauthBearer', type=d.T.boolean)]),
          withEnableOauthBearer(enableOauthBearer): { authentication+: { enableOauthBearer: enableOauthBearer } },
          '#withEnablePlain':: d.fn(help='"Enable or disable OAuth authentication over SASL_PLAIN. There is no re-authentication support when this mechanism is used. Default value is `false`."', args=[d.arg(name='enablePlain', type=d.T.boolean)]),
          withEnablePlain(enablePlain): { authentication+: { enablePlain: enablePlain } },
          '#withFailFast':: d.fn(help='"Enable or disable termination of Kafka broker processes due to potentially recoverable runtime errors during startup. Default value is `true`."', args=[d.arg(name='failFast', type=d.T.boolean)]),
          withFailFast(failFast): { authentication+: { failFast: failFast } },
          '#withFallbackUserNameClaim':: d.fn(help='"The fallback username claim to be used for the user ID if the claim specified by `userNameClaim` is not present. This is useful when `client_credentials` authentication only results in the client ID being provided in another claim. It only takes effect if `userNameClaim` is set."', args=[d.arg(name='fallbackUserNameClaim', type=d.T.string)]),
          withFallbackUserNameClaim(fallbackUserNameClaim): { authentication+: { fallbackUserNameClaim: fallbackUserNameClaim } },
          '#withFallbackUserNamePrefix':: d.fn(help='"The prefix to use with the value of `fallbackUserNameClaim` to construct the user id. This only takes effect if `fallbackUserNameClaim` is true, and the value is present for the claim. Mapping usernames and client ids into the same user id space is useful in preventing name collisions."', args=[d.arg(name='fallbackUserNamePrefix', type=d.T.string)]),
          withFallbackUserNamePrefix(fallbackUserNamePrefix): { authentication+: { fallbackUserNamePrefix: fallbackUserNamePrefix } },
          '#withGroupsClaim':: d.fn(help='"JsonPath query used to extract groups for the user during authentication. Extracted groups can be used by a custom authorizer. By default no groups are extracted."', args=[d.arg(name='groupsClaim', type=d.T.string)]),
          withGroupsClaim(groupsClaim): { authentication+: { groupsClaim: groupsClaim } },
          '#withGroupsClaimDelimiter':: d.fn(help="\"A delimiter used to parse groups when they are extracted as a single String value rather than a JSON array. Default value is ',' (comma).\"", args=[d.arg(name='groupsClaimDelimiter', type=d.T.string)]),
          ...
          '#withHttpRetryPauseMs':: d.fn(help='"The pause to take before retrying a failed HTTP request. If not set, the default is to not pause at all but to immediately repeat a request."', args=[d.arg(name='httpRetryPauseMs', type=d.T.integer)]),
          ...
          '#withIntrospectionEndpointUri':: d.fn(help='"URI of the token introspection endpoint which can be used to validate opaque non-JWT tokens."', args=[d.arg(name='introspectionEndpointUri', type=d.T.string)]),
          withIntrospectionEndpointUri(introspectionEndpointUri): { authentication+: { introspectionEndpointUri: introspectionEndpointUri } },
          '#withJwksEndpointUri':: d.fn(help='"URI of the JWKS certificate endpoint, which can be used for local JWT validation."', args=[d.arg(name='jwksEndpointUri', type=d.T.string)]),
          withJwksEndpointUri(jwksEndpointUri): { authentication+: { jwksEndpointUri: jwksEndpointUri } },
          '#withJwksExpirySeconds':: d.fn(help='"Configures how often are the JWKS certificates considered valid. The expiry interval has to be at least 60 seconds longer then the refresh interval specified in `jwksRefreshSeconds`. Defaults to 360 seconds."', args=[d.arg(name='jwksExpirySeconds', type=d.T.integer)]),
          withJwksExpirySeconds(jwksExpirySeconds): { authentication+: { jwksExpirySeconds: jwksExpirySeconds } },
          '#withJwksIgnoreKeyUse':: d.fn(help="\"Flag to ignore the 'use' attribute of `key` declarations in a JWKS endpoint response. Default value is `false`.\"", args=[d.arg(name='jwksIgnoreKeyUse', type=d.T.boolean)]),
          withJwksIgnoreKeyUse(jwksIgnoreKeyUse): { authentication+: { jwksIgnoreKeyUse: jwksIgnoreKeyUse } },
          '#withJwksMinRefreshPauseSeconds':: d.fn(help='"The minimum pause between two consecutive refreshes. When an unknown signing key is encountered the refresh is scheduled immediately, but will always wait for this minimum pause. Defaults to 1 second."', args=[d.arg(name='jwksMinRefreshPauseSeconds', type=d.T.integer)]),
          ...
          '#withJwksRefreshSeconds':: d.fn(help='"Configures how often are the JWKS certificates refreshed. The refresh interval has to be at least 60 seconds shorter then the expiry interval specified in `jwksExpirySeconds`. Defaults to 300 seconds."', args=[d.arg(name='jwksRefreshSeconds', type=d.T.integer)]),
          ...
          '#withMaxSecondsWithoutReauthentication':: d.fn(help='"Maximum number of seconds the authenticated session remains valid without re-authentication. This enables Apache Kafka re-authentication feature, and causes sessions to expire when the access token expires. If the access token expires before max time or if max time is reached, the client has to re-authenticate, otherwise the server will drop the connection. Not set by default - the authenticated session does not expire when the access token expires. This option only applies to SASL_OAUTHBEARER authentication mechanism (when `enableOauthBearer` is `true`)."', args=[d.arg(name='maxSecondsWithoutReauthentication', type=d.T.integer)]),
          ...
          '#withSecrets':: d.fn(help='"Secrets to be mounted to `/opt/kafka/custom-authn-secrets/custom-listener-<listener_name>-<port>/<secret_name>`."', args=[d.arg(name='secrets', type=d.T.array)]),
          withSecrets(secrets): { authentication+: { secrets: if std.isArray(v=secrets) then secrets else [secrets] } },
          '#withSecretsMixin':: d.fn(help='"Secrets to be mounted to `/opt/kafka/custom-authn-secrets/custom-listener-<listener_name>-<port>/<secret_name>`."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='secrets', type=d.T.array)]),
          withSecretsMixin(secrets): { authentication+: { secrets+: if std.isArray(v=secrets) then secrets else [secrets] } },
          '#withServerBearerTokenLocation':: d.fn(help='"Path to the file on the local filesystem that contains a bearer token to be used instead of client ID and secret when authenticating to authorization server."', args=[d.arg(name='serverBearerTokenLocation', type=d.T.string)]),
          ...
          '#withTokenEndpointUri':: d.fn(help="\"URI of the Token Endpoint to use with SASL_PLAIN mechanism when the client authenticates with `clientId` and a `secret`. If set, the client can authenticate over SASL_PLAIN by either setting `username` to `clientId`, and setting `password` to client `secret`, or by setting `username` to account username, and `password` to access token prefixed with `$accessToken:`. If this option is not set, the `password` is always interpreted as an access token (without a prefix), and `username` as the account username (a so called 'no-client-credentials' mode).\"", args=[d.arg(name='tokenEndpointUri', type=d.T.string)]),
          withTokenEndpointUri(tokenEndpointUri): { authentication+: { tokenEndpointUri: tokenEndpointUri } },
          '#withType':: d.fn(help='"Authentication type. `oauth` type uses SASL OAUTHBEARER Authentication. `scram-sha-512` type uses SASL SCRAM-SHA-512 Authentication. `tls` type uses TLS Client Authentication. `tls` type is supported only on TLS listeners.`custom` type allows for any authentication type to be used."', args=[d.arg(name='type', type=d.T.string)]),
          withType(type): { authentication+: { type: type } },
          '#withUserInfoEndpointUri':: d.fn(help='"URI of the User Info Endpoint to use as a fallback to obtaining the user id when the Introspection Endpoint does not return information that can be used for the user id. "', args=[d.arg(name='userInfoEndpointUri', type=d.T.string)]),
          withUserInfoEndpointUri(userInfoEndpointUri): { authentication+: { userInfoEndpointUri: userInfoEndpointUri } },
          '#withUserNameClaim':: d.fn(help='"Name of the claim from the JWT authentication token, Introspection Endpoint response or User Info Endpoint response which will be used to extract the user id. Defaults to `sub`."', args=[d.arg(name='userNameClaim', type=d.T.string)]),
          withUserNameClaim(userNameClaim): { authentication+: { userNameClaim: userNameClaim } },
          '#withUserNamePrefix':: d.fn(help='"The prefix to use with the value of `userNameClaim` to construct the user ID. This only takes effect if `userNameClaim` is specified and the value is present for the claim. When used in combination with `fallbackUserNameClaims`, it ensures consistent mapping of usernames and client IDs into the same user ID space and prevents name collisions."', args=[d.arg(name='userNamePrefix', type=d.T.string)]),
          withUserNamePrefix(userNamePrefix): { authentication+: { userNamePrefix: userNamePrefix } },
          '#withValidIssuerUri':: d.fn(help='"URI of the token issuer used for authentication."', args=[d.arg(name='validIssuerUri', type=d.T.string)]),
          withValidIssuerUri(validIssuerUri): { authentication+: { validIssuerUri: validIssuerUri } },
          '#withValidTokenType':: d.fn(help='"Valid value for the `token_type` attribute returned by the Introspection Endpoint. No default value, and not checked by default."', args=[d.arg(name='validTokenType', type=d.T.string)]),
      ...
      '#storage':: d.obj(help='"Storage is now configured in the `KafkaNodePool` resources and this option is ignored."'),
      storage: {
        '#overrides':: d.obj(help='"As of Strimzi 0.46.0, the storage overrides for individual brokers are not supported anymore and this option is ignored."'),
        overrides: {
        ...
        volumes: {
          ...
          '#withId':: d.fn(help='"Storage identification number. Mandatory for storage volumes defined with a `jbod` storage type configuration."', args=[d.arg(name='id', type=d.T.integer)]),
          withId(id): { id: id },
          '#withKraftMetadata':: d.fn(help='"Specifies whether this volume should be used for storing KRaft metadata. This property is optional. When set, the only currently supported value is `shared`. At most one volume can have this property set."', args=[d.arg(name='kraftMetadata', type=d.T.string)]),
          withKraftMetadata(kraftMetadata): { kraftMetadata: kraftMetadata },
          '#withOverrides':: d.fn(help='"As of Strimzi 0.46.0, the storage overrides for individual brokers are not supported anymore and this option is ignored."', args=[d.arg(name='overrides', type=d.T.array)]),
          withOverrides(overrides): { overrides: if std.isArray(v=overrides) then overrides else [overrides] },
          '#withOverridesMixin':: d.fn(help='"As of Strimzi 0.46.0, the storage overrides for individual brokers are not supported anymore and this option is ignored."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='overrides', type=d.T.array)]),
          ...
          '#withSize':: d.fn(help='"When `type=persistent-claim`, defines the size of the persistent volume claim, such as 100Gi. Mandatory when `type=persistent-claim`."', args=[d.arg(name='size', type=d.T.string)]),
      ...
      '#withReplicas':: d.fn(help='"Replicas are now configured in `KafkaNodePool` resources and this option is ignored."', args=[d.arg(name='replicas', type=d.T.integer)]),
    ...
    '#zookeeper':: d.obj(help='"As of Strimzi 0.46.0, ZooKeeper-based Apache Kafka clusters are not supported anymore and this option is ignored."'),
    zookeeper: {
      '#jmxOptions':: d.obj(help='"JMX Options for Zookeeper nodes."'),
      jmxOptions: {
        '#authentication':: d.obj(help='"Authentication configuration for connecting to the JMX port."'),
        authentication: {
          '#withType':: d.fn(help='"Authentication type. Currently the only supported types are `password`.`password` type creates a username and protected port with no TLS."', args=[d.arg(name='type', type=d.T.string)]),
      ...
      '#template':: d.obj(help='"Template for ZooKeeper cluster resources. The template allows users to specify how the Kubernetes resources are generated."'),
      template: {
        ...
        '#jmxSecret':: d.obj(help='"Template for Secret of the Zookeeper Cluster JMX authentication."'),
        jmxSecret: {
          '#metadata':: d.obj(help='"Metadata applied to the resource."'),
          metadata: {
            '#withAnnotations':: d.fn(help='"Annotations added to the Kubernetes resource."', args=[d.arg(name='annotations', type=d.T.object)]),
        ...
        '#podSet':: d.obj(help='"Template for ZooKeeper `StrimziPodSet` resource."'),
        podSet: {
          '#metadata':: d.obj(help='"Metadata applied to the resource."'),
          metadata: {
            '#withAnnotations':: d.fn(help='"Annotations added to the Kubernetes resource."', args=[d.arg(name='annotations', type=d.T.object)]),
        ...
        '#serviceAccount':: d.obj(help='"Template for the ZooKeeper service account."'),
        serviceAccount: {
          '#metadata':: d.obj(help='"Metadata applied to the resource."'),
          metadata: {
            '#withAnnotations':: d.fn(help='"Annotations added to the Kubernetes resource."', args=[d.arg(name='annotations', type=d.T.object)]),
      ...
      '#withConfig':: d.fn(help='"The ZooKeeper broker config. Properties with the following prefixes cannot be set: server., dataDir, dataLogDir, clientPort, authProvider, quorum.auth, requireClientAuthScheme, snapshot.trust.empty, standaloneEnabled, reconfigEnabled, 4lw.commands.whitelist, secureClientPort, ssl., serverCnxnFactory, sslQuorum (with the exception of: ssl.protocol, ssl.quorum.protocol, ssl.enabledProtocols, ssl.quorum.enabledProtocols, ssl.ciphersuites, ssl.quorum.ciphersuites, ssl.hostnameVerification, ssl.quorum.hostnameVerification)."', args=[d.arg(name='config', type=d.T.object)]),
      withConfig(config): { spec+: { zookeeper+: { config: config } } },
      '#withConfigMixin':: d.fn(help='"The ZooKeeper broker config. Properties with the following prefixes cannot be set: server., dataDir, dataLogDir, clientPort, authProvider, quorum.auth, requireClientAuthScheme, snapshot.trust.empty, standaloneEnabled, reconfigEnabled, 4lw.commands.whitelist, secureClientPort, ssl., serverCnxnFactory, sslQuorum (with the exception of: ssl.protocol, ssl.quorum.protocol, ssl.enabledProtocols, ssl.quorum.enabledProtocols, ssl.ciphersuites, ssl.quorum.ciphersuites, ssl.hostnameVerification, ssl.quorum.hostnameVerification)."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='config', type=d.T.object)]),
      withConfigMixin(config): { spec+: { zookeeper+: { config+: config } } },
      '#withImage':: d.fn(help='"The container image used for ZooKeeper pods. If no image name is explicitly specified, it is determined based on the Kafka version set in `spec.kafka.version`. The image names are specifically mapped to corresponding versions in the Cluster Operator configuration."', args=[d.arg(name='image', type=d.T.string)]),
