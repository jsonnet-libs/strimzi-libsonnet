{
  ...
  spec: {
    ...
    '#template':: d.obj(help='"Template for Kafka Bridge resources. The template allows users to specify how a `Deployment` and `Pod` is generated."'),
    template: {
      ...
      '#clusterRoleBinding':: d.obj(help='"Template for the Kafka Bridge ClusterRoleBinding."'),
      clusterRoleBinding: {
        '#metadata':: d.obj(help='"Metadata applied to the resource."'),
        metadata: {
          '#withAnnotations':: d.fn(help='"Annotations added to the Kubernetes resource."', args=[d.arg(name='annotations', type=d.T.object)]),
      ...
      '#initContainer':: d.obj(help='"Template for the Kafka Bridge init container."'),
      initContainer: {
        '#env':: d.obj(help='"Environment variables which should be applied to the container."'),
        env: {
          '#valueFrom':: d.obj(help='"Reference to the secret or config map property to which the environment variable is set."'),
