  ...
  spec: {
    ...
    authorization: {
      ...
      acls: {
        ...
        '#withHost':: d.fn(help='"The host from which the action described in the ACL rule is allowed or denied. If not set, it defaults to `*`, allowing or denying the action from any host."', args=[d.arg(name='host', type=d.T.string)]),
        ...
        '#withOperations':: d.fn(help='"List of operations to allow or deny. Supported operations are: Read, Write, Create, Delete, Alter, Describe, ClusterAction, AlterConfigs, DescribeConfigs, IdempotentWrite and All. Only certain operations work with the specified resource."', args=[d.arg(name='operations', type=d.T.array)]),
        withOperations(operations): { operations: if std.isArray(v=operations) then operations else [operations] },
        '#withOperationsMixin':: d.fn(help='"List of operations to allow or deny. Supported operations are: Read, Write, Create, Delete, Alter, Describe, ClusterAction, AlterConfigs, DescribeConfigs, IdempotentWrite and All. Only certain operations work with the specified resource."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='operations', type=d.T.array)]),
        withOperationsMixin(operations): { operations+: if std.isArray(v=operations) then operations else [operations] },
        '#withType':: d.fn(help='"The type of the rule. ACL rules with type `allow` are used to allow user to execute the specified operations. ACL rules with type `deny` are used to deny user to execute the specified operations. Default value is `allow`."', args=[d.arg(name='type', type=d.T.string)]),
      ...
      '#withType':: d.fn(help='"Authorization type. Currently the only supported type is `simple`. `simple` authorization type uses the Kafka Admin API for managing the ACL rules."', args=[d.arg(name='type', type=d.T.string)]),
      withType(type): { spec+: { authorization+: { type: type } } },
    },
    '#quotas':: d.obj(help='"Quotas on requests to control the broker resources used by clients. Network bandwidth and request rate quotas can be enforced. For more information, see the Apache Kafka design documentation about quotas."'),
    quotas: {
