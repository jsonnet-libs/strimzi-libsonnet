{
  ...
  '#spec':: d.obj(help='"The specification of the HTTP Bridge."'),
  spec: {
    ...
    consumer: {
      ...
      '#withEnabled':: d.fn(help='"Whether the HTTP consumer should be enabled or disabled. The default is enabled (`true`)."', args=[d.arg(name='enabled', type=d.T.boolean)]),
      withEnabled(enabled): { spec+: { consumer+: { enabled: enabled } } },
      '#withTimeoutSeconds':: d.fn(help='"The timeout in seconds for deleting inactive consumers, default is -1 (disabled)."', args=[d.arg(name='timeoutSeconds', type=d.T.integer)]),
      withTimeoutSeconds(timeoutSeconds): { spec+: { consumer+: { timeoutSeconds: timeoutSeconds } } },
    },
    ...
    http: {
      ...
      '#withPort':: d.fn(help='"Port the server listens on."', args=[d.arg(name='port', type=d.T.integer)]),
    ...
    '#logging':: d.obj(help='"Logging configuration for HTTP Bridge."'),
    logging: {
    ...
    producer: {
      ...
      '#withEnabled':: d.fn(help='"Whether the HTTP producer should be enabled or disabled. The default is enabled (`true`)."', args=[d.arg(name='enabled', type=d.T.boolean)]),
      withEnabled(enabled): { spec+: { producer+: { enabled: enabled } } },
    },
    ...
    '#template':: d.obj(help='"Template for HTTP Bridge resources. The template allows users to specify how a `Deployment` and `Pod` is generated."'),
    template: {
      '#apiService':: d.obj(help='"Template for HTTP Bridge API `Service`."'),
      apiService: {
      ...
      '#bridgeContainer':: d.obj(help='"Template for the HTTP Bridge container."'),
      bridgeContainer: {
        ...
        securityContext: {
          ...
          appArmorProfile: {
            ...
            withLocalhostProfile(localhostProfile): { spec+: { template+: { bridgeContainer+: { securityContext+: { appArmorProfile+: { localhostProfile: localhostProfile } } } } } },
            '#withType':: d.fn(help='', args=[d.arg(name='type', type=d.T.string)]),
            withType(type): { spec+: { template+: { bridgeContainer+: { securityContext+: { appArmorProfile+: { type: type } } } } } },
          },
        ...
        withVolumeMounts(volumeMounts): { spec+: { template+: { bridgeContainer+: { volumeMounts: if std.isArray(v=volumeMounts) then volumeMounts else [volumeMounts] } } } },
        ...
        withVolumeMountsMixin(volumeMounts): { spec+: { template+: { bridgeContainer+: { volumeMounts+: if std.isArray(v=volumeMounts) then volumeMounts else [volumeMounts] } } } },
      },
      '#clusterRoleBinding':: d.obj(help='"Template for the HTTP Bridge ClusterRoleBinding."'),
      clusterRoleBinding: {
        '#metadata':: d.obj(help='"Metadata applied to the resource."'),
        metadata: {
          '#withAnnotations':: d.fn(help='"Annotations added to the Kubernetes resource."', args=[d.arg(name='annotations', type=d.T.object)]),
      ...
      '#deployment':: d.obj(help='"Template for HTTP Bridge `Deployment`."'),
      deployment: {
        '#metadata':: d.obj(help='"Metadata applied to the resource."'),
        metadata: {
          '#withAnnotations':: d.fn(help='"Annotations added to the Kubernetes resource."', args=[d.arg(name='annotations', type=d.T.object)]),
      ...
      '#initContainer':: d.obj(help='"Template for the HTTP Bridge init container."'),
      initContainer: {
        '#env':: d.obj(help='"Environment variables which should be applied to the container."'),
        env: {
          '#valueFrom':: d.obj(help='"Reference to the secret or config map property to which the environment variable is set."'),
      ...
      '#pod':: d.obj(help='"Template for HTTP Bridge `Pods`."'),
      pod: {
      ...
      '#podDisruptionBudget':: d.obj(help='"Template for HTTP Bridge `PodDisruptionBudget`."'),
      podDisruptionBudget: {
      ...
      '#serviceAccount':: d.obj(help='"Template for the HTTP Bridge service account."'),
      serviceAccount: {
        '#metadata':: d.obj(help='"Metadata applied to the resource."'),
        metadata: {
          '#withAnnotations':: d.fn(help='"Annotations added to the Kubernetes resource."', args=[d.arg(name='annotations', type=d.T.object)]),
    ...
    '#tls':: d.obj(help='"TLS configuration for connecting HTTP Bridge to the cluster."'),
    tls: {
    ...
    '#tracing':: d.obj(help='"The configuration of tracing in HTTP Bridge."'),
    tracing: {
    ...
    '#withEnableMetrics':: d.fn(help='"Enable the metrics for the HTTP Bridge. Default is false."', args=[d.arg(name='enableMetrics', type=d.T.boolean)]),
    withEnableMetrics(enableMetrics): { spec+: { enableMetrics: enableMetrics } },
    '#withImage':: d.fn(help='"The container image used for HTTP Bridge pods. If no image name is explicitly specified, the image name corresponds to the image specified in the Cluster Operator configuration. If an image name is not defined in the Cluster Operator configuration, a default value is used."', args=[d.arg(name='image', type=d.T.string)]),
    withImage(image): { spec+: { image: image } },
    '#withReplicas':: d.fn(help='"The number of pods in the `Deployment`. Required in the `v1` version of the Strimzi API. Defaults to `1` in the `v1beta2` version of the Strimzi API."', args=[d.arg(name='replicas', type=d.T.integer)]),
