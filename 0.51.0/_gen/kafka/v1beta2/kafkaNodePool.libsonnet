  ...
  spec: {
    ...
    storage: {
      ...
      volumes: {
        ...
        withClass(class): { class: class },
        '#withDeleteClaim':: d.fn(help='"Specifies whether the persistent volume claim is deleted when a Kafka node is deleted. Optional. Defaults to `false`."', args=[d.arg(name='deleteClaim', type=d.T.boolean)]),
        ...
        '#withVolumeAttributesClass':: d.fn(help='"Specifies `VolumeAttributeClass` name for dynamically configuring storage attributes."', args=[d.arg(name='volumeAttributesClass', type=d.T.string)]),
      ...
      '#withKraftMetadata':: d.fn(help='"Specifies whether this volume should be used for storing KRaft metadata. This property is optional. When set, the only currently supported value is `shared`. At most one volume can have this property set."', args=[d.arg(name='kraftMetadata', type=d.T.string)]),
      withKraftMetadata(kraftMetadata): { spec+: { storage+: { kraftMetadata: kraftMetadata } } },
      '#withOverrides':: d.fn(help='"As of Strimzi 0.46.0, the storage overrides for individual brokers are not supported anymore and this option is ignored."', args=[d.arg(name='overrides', type=d.T.array)]),
      ...
      '#withVolumeAttributesClass':: d.fn(help='"Specifies `VolumeAttributeClass` name for dynamically configuring storage attributes."', args=[d.arg(name='volumeAttributesClass', type=d.T.string)]),
      withVolumeAttributesClass(volumeAttributesClass): { spec+: { storage+: { volumeAttributesClass: volumeAttributesClass } } },
    ...
    template: {
      ...
      kafkaContainer: {
        ...
        securityContext: {
          ...
          appArmorProfile: {
            '#withLocalhostProfile':: d.fn(help='', args=[d.arg(name='localhostProfile', type=d.T.string)]),
            withLocalhostProfile(localhostProfile): { spec+: { template+: { kafkaContainer+: { securityContext+: { appArmorProfile+: { localhostProfile: localhostProfile } } } } } },
            '#withType':: d.fn(help='', args=[d.arg(name='type', type=d.T.string)]),
            withType(type): { spec+: { template+: { kafkaContainer+: { securityContext+: { appArmorProfile+: { type: type } } } } } },
          },
          '#capabilities':: d.obj(help=''),
          capabilities: {
            '#withAdd':: d.fn(help='', args=[d.arg(name='add', type=d.T.array)]),
        ...
        '#withVolumeMounts':: d.fn(help='"Additional volume mounts which should be applied to the container."', args=[d.arg(name='volumeMounts', type=d.T.array)]),
        withVolumeMounts(volumeMounts): { spec+: { template+: { kafkaContainer+: { volumeMounts: if std.isArray(v=volumeMounts) then volumeMounts else [volumeMounts] } } } },
        '#withVolumeMountsMixin':: d.fn(help='"Additional volume mounts which should be applied to the container."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='volumeMounts', type=d.T.array)]),
        withVolumeMountsMixin(volumeMounts): { spec+: { template+: { kafkaContainer+: { volumeMounts+: if std.isArray(v=volumeMounts) then volumeMounts else [volumeMounts] } } } },
      },
    ...
    '#withRoles':: d.fn(help='"The roles assigned to the node pool. Supported values are `broker` and `controller`. This property is required."', args=[d.arg(name='roles', type=d.T.array)]),
    withRoles(roles): { spec+: { roles: if std.isArray(v=roles) then roles else [roles] } },
    '#withRolesMixin':: d.fn(help='"The roles assigned to the node pool. Supported values are `broker` and `controller`. This property is required."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='roles', type=d.T.array)]),
