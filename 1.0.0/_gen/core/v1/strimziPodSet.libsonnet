{
  ...
  '#':: d.pkg(name='strimziPodSet', url='', help=''),
  ...
  '#new':: d.fn(help='new returns an instance of StrimziPodSet', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'core.strimzi.io/v1',
    kind: 'StrimziPodSet',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"The specification of the StrimziPodSet."'),
  spec: {
    '#selector':: d.obj(help='"Selector is a label query which matches all the pods managed by this `StrimziPodSet`. Only `matchLabels` is supported. If `matchExpressions` is set, it will be ignored."'),
    selector: {
    ...
    '#withPods':: d.fn(help='"The Pods managed by this StrimziPodSet."', args=[d.arg(name='pods', type=d.T.array)]),
    withPods(pods): { spec+: { pods: if std.isArray(v=pods) then pods else [pods] } },
    '#withPodsMixin':: d.fn(help='"The Pods managed by this StrimziPodSet."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='pods', type=d.T.array)]),
    withPodsMixin(pods): { spec+: { pods+: if std.isArray(v=pods) then pods else [pods] } },
  },
  '#mixin': 'ignore',
  mixin: self,
}
