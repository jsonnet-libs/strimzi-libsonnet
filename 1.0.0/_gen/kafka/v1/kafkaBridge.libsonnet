{
  ...
  spec: {
    ...
    http: {
      ...
      '#tls':: d.obj(help='"TLS configuration for clients connections to the HTTP Bridge."'),
      tls: {
        '#certificateAndKey':: d.obj(help='"Reference to the `Secret` which holds the certificate and private key pair."'),
        certificateAndKey: {
          '#withCertificate':: d.fn(help='"The name of the file certificate in the Secret."', args=[d.arg(name='certificate', type=d.T.string)]),
          withCertificate(certificate): { spec+: { http+: { tls+: { certificateAndKey+: { certificate: certificate } } } } },
          '#withKey':: d.fn(help='"The name of the private key in the secret. The private key must be in unencrypted PKCS #8 format. For more information, see RFC 5208: https://datatracker.ietf.org/doc/html/rfc5208."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { spec+: { http+: { tls+: { certificateAndKey+: { key: key } } } } },
          '#withSecretName':: d.fn(help='"The name of the Secret containing the certificate."', args=[d.arg(name='secretName', type=d.T.string)]),
          withSecretName(secretName): { spec+: { http+: { tls+: { certificateAndKey+: { secretName: secretName } } } } },
        },
        '#withConfig':: d.fn(help='"Additional configuration for the HTTP server TLS. Properties with the following prefixes cannot be set: ssl. (with the exception of: ssl.enabled.cipher.suites, ssl.enabled.protocols)."', args=[d.arg(name='config', type=d.T.object)]),
        withConfig(config): { spec+: { http+: { tls+: { config: config } } } },
        '#withConfigMixin':: d.fn(help='"Additional configuration for the HTTP server TLS. Properties with the following prefixes cannot be set: ssl. (with the exception of: ssl.enabled.cipher.suites, ssl.enabled.protocols)."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='config', type=d.T.object)]),
        withConfigMixin(config): { spec+: { http+: { tls+: { config+: config } } } },
      },
    ...
    '#withConfig':: d.fn(help='"Additional configuration for the HTTP bridge. The following prefixes cannot be set: kafka., http., bridge.metrics. The following options cannot be set: bridge.id, bridge.tracing, bridge.metrics."', args=[d.arg(name='config', type=d.T.object)]),
    withConfig(config): { spec+: { config: config } },
    '#withConfigMixin':: d.fn(help='"Additional configuration for the HTTP bridge. The following prefixes cannot be set: kafka., http., bridge.metrics. The following options cannot be set: bridge.id, bridge.tracing, bridge.metrics."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='config', type=d.T.object)]),
