---
permalink: /0.49.1/kafka/v1/kafkaNodePool/
---

# kafka.v1.kafkaNodePool
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.storage`](#obj-specstorage)
    ...
    * [`fn withVolumeAttributesClass(volumeAttributesClass)`](#fn-specstoragewithvolumeattributesclass)
    ...
    * [`obj spec.storage.volumes`](#obj-specstoragevolumes)
      ...
      * [`fn withVolumeAttributesClass(volumeAttributesClass)`](#fn-specstoragevolumeswithvolumeattributesclass)
  * [`obj spec.template`](#obj-spectemplate)
    ...
    * [`obj spec.template.kafkaContainer`](#obj-spectemplatekafkacontainer)
      ...
      * [`fn withVolumeMounts(volumeMounts)`](#fn-spectemplatekafkacontainerwithvolumemounts)
      * [`fn withVolumeMountsMixin(volumeMounts)`](#fn-spectemplatekafkacontainerwithvolumemountsmixin)
      * [`obj spec.template.kafkaContainer.env`](#obj-spectemplatekafkacontainerenv)
        ...
        * [`obj spec.template.kafkaContainer.env.valueFrom`](#obj-spectemplatekafkacontainerenvvaluefrom)
          * [`obj spec.template.kafkaContainer.env.valueFrom.configMapKeyRef`](#obj-spectemplatekafkacontainerenvvaluefromconfigmapkeyref)
            * [`fn withKey(key)`](#fn-spectemplatekafkacontainerenvvaluefromconfigmapkeyrefwithkey)
            * [`fn withName(name)`](#fn-spectemplatekafkacontainerenvvaluefromconfigmapkeyrefwithname)
            * [`fn withOptional(optional)`](#fn-spectemplatekafkacontainerenvvaluefromconfigmapkeyrefwithoptional)
          * [`obj spec.template.kafkaContainer.env.valueFrom.secretKeyRef`](#obj-spectemplatekafkacontainerenvvaluefromsecretkeyref)
            * [`fn withKey(key)`](#fn-spectemplatekafkacontainerenvvaluefromsecretkeyrefwithkey)
            * [`fn withName(name)`](#fn-spectemplatekafkacontainerenvvaluefromsecretkeyrefwithname)
            * [`fn withOptional(optional)`](#fn-spectemplatekafkacontainerenvvaluefromsecretkeyrefwithoptional)
      ...
      * [`obj spec.template.kafkaContainer.volumeMounts`](#obj-spectemplatekafkacontainervolumemounts)
        * [`fn withMountPath(mountPath)`](#fn-spectemplatekafkacontainervolumemountswithmountpath)
        * [`fn withMountPropagation(mountPropagation)`](#fn-spectemplatekafkacontainervolumemountswithmountpropagation)
        * [`fn withName(name)`](#fn-spectemplatekafkacontainervolumemountswithname)
        * [`fn withReadOnly(readOnly)`](#fn-spectemplatekafkacontainervolumemountswithreadonly)
        * [`fn withRecursiveReadOnly(recursiveReadOnly)`](#fn-spectemplatekafkacontainervolumemountswithrecursivereadonly)
        * [`fn withSubPath(subPath)`](#fn-spectemplatekafkacontainervolumemountswithsubpath)
        * [`fn withSubPathExpr(subPathExpr)`](#fn-spectemplatekafkacontainervolumemountswithsubpathexpr)
...
### fn spec.storage.withVolumeAttributesClass
...
### fn spec.storage.volumes.withVolumeAttributesClass
...
### fn spec.template.kafkaContainer.withVolumeMounts
...
### fn spec.template.kafkaContainer.withVolumeMountsMixin
...
## obj spec.template.kafkaContainer.env.valueFrom

"Reference to the secret or config map property to which the environment variable is set."

## obj spec.template.kafkaContainer.env.valueFrom.configMapKeyRef

"Reference to a key in a config map."

### fn spec.template.kafkaContainer.env.valueFrom.configMapKeyRef.withKey
...
### fn spec.template.kafkaContainer.env.valueFrom.configMapKeyRef.withName
...
### fn spec.template.kafkaContainer.env.valueFrom.configMapKeyRef.withOptional
...
## obj spec.template.kafkaContainer.env.valueFrom.secretKeyRef

"Reference to a key in a secret."

### fn spec.template.kafkaContainer.env.valueFrom.secretKeyRef.withKey
...
### fn spec.template.kafkaContainer.env.valueFrom.secretKeyRef.withName
...
### fn spec.template.kafkaContainer.env.valueFrom.secretKeyRef.withOptional
...
## obj spec.template.kafkaContainer.volumeMounts

"Additional volume mounts which should be applied to the container."

### fn spec.template.kafkaContainer.volumeMounts.withMountPath
...
### fn spec.template.kafkaContainer.volumeMounts.withMountPropagation
...
### fn spec.template.kafkaContainer.volumeMounts.withName
...
### fn spec.template.kafkaContainer.volumeMounts.withReadOnly
...
### fn spec.template.kafkaContainer.volumeMounts.withRecursiveReadOnly
...
### fn spec.template.kafkaContainer.volumeMounts.withSubPath
...
### fn spec.template.kafkaContainer.volumeMounts.withSubPathExpr
