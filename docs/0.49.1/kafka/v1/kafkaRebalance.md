---
permalink: /0.49.1/kafka/v1/kafkaRebalance/
---

# kafka.v1.kafkaRebalance
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withMoveReplicasOffVolumes(moveReplicasOffVolumes)`](#fn-specwithmovereplicasoffvolumes)
  * [`fn withMoveReplicasOffVolumesMixin(moveReplicasOffVolumes)`](#fn-specwithmovereplicasoffvolumesmixin)
  ...
  * [`obj spec.moveReplicasOffVolumes`](#obj-specmovereplicasoffvolumes)
    * [`fn withBrokerId(brokerId)`](#fn-specmovereplicasoffvolumeswithbrokerid)
    * [`fn withVolumeIds(volumeIds)`](#fn-specmovereplicasoffvolumeswithvolumeids)
    * [`fn withVolumeIdsMixin(volumeIds)`](#fn-specmovereplicasoffvolumeswithvolumeidsmixin)
...
### fn spec.withMoveReplicasOffVolumes

```ts
withMoveReplicasOffVolumes(moveReplicasOffVolumes)
```

"List of brokers and their corresponding volumes from which replicas need to be moved."

### fn spec.withMoveReplicasOffVolumesMixin

```ts
withMoveReplicasOffVolumesMixin(moveReplicasOffVolumes)
```
...
## obj spec.moveReplicasOffVolumes

"List of brokers and their corresponding volumes from which replicas need to be moved."

### fn spec.moveReplicasOffVolumes.withBrokerId
...
### fn spec.moveReplicasOffVolumes.withVolumeIds
...
### fn spec.moveReplicasOffVolumes.withVolumeIdsMixin

```ts
withVolumeIdsMixin(volumeIds)
```
