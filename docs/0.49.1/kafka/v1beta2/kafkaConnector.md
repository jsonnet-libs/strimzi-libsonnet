---
permalink: /0.49.1/kafka/v1beta2/kafkaConnector/
---

# kafka.v1beta2.kafkaConnector
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.alterOffsets`](#obj-specalteroffsets)
    * [`obj spec.alterOffsets.fromConfigMap`](#obj-specalteroffsetsfromconfigmap)
      * [`fn withName(name)`](#fn-specalteroffsetsfromconfigmapwithname)
  * [`obj spec.autoRestart`](#obj-specautorestart)
    * [`fn withEnabled(enabled)`](#fn-specautorestartwithenabled)
    * [`fn withMaxRestarts(maxRestarts)`](#fn-specautorestartwithmaxrestarts)
  * [`obj spec.listOffsets`](#obj-speclistoffsets)
    * [`obj spec.listOffsets.toConfigMap`](#obj-speclistoffsetstoconfigmap)
      * [`fn withName(name)`](#fn-speclistoffsetstoconfigmapwithname)
...
new returns an instance of KafkaConnector
...
## obj spec.alterOffsets

"Configuration for altering offsets."

## obj spec.alterOffsets.fromConfigMap

"Reference to the ConfigMap where the new offsets are stored."

### fn spec.alterOffsets.fromConfigMap.withName
...
### fn spec.autoRestart.withMaxRestarts
